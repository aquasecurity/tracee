	...
	app := &cli.App{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{
				...
				Value:   "rego",
				EnvVars: []string{"TRACEE_REGO_RUNTIME_TARGET"},
			},
			&cli.BoolFlag{
				Name:  "list-events",
			...
			&cli.BoolFlag{
				...
				Value:   false,
				EnvVars: []string{"TRACEE_ALLOW_HIGH_CAPABILITIES"},
			},
		},
	}
	err := app.Run(os.Args)
