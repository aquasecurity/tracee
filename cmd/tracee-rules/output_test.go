	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedJson: `{
				...
				"SigMetadata":{
					"ID":"TRC-1","Version":"0.1.0","Name":"Standard Input/Output Over Socket","Description":"Redirection of process's standard input/output to socket","Tags":["linux","container"],"Properties":{"MITRE ATT\u0026CK":"Persistence: Server Software Component","Severity":3}, "EventName":"stdio_over_socket"
				}
			}`,
		},
	}
