...
func GetMetrics(cmdCobra *cobra.Command) (cmd.Metrics, error) {
	...
	// get flags throw cobra and not viper
	// viper will take the stream flags which is higher source to take from
	// we resolve to use the flags from cmd and not viper
