	...
	app := &cli.App{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"TRACEE_INSTALL_PATH"},
			},
			&cli.BoolFlag{
				Name:        "metrics",
			...
			&cli.BoolFlag{
				...
				Destination: &enrich,
				EnvVars:     []string{"TRACEE_CONTAINERS_ENRICHMENT"},
			},
			&cli.StringSliceFlag{
