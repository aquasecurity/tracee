...
var EventsIDToParams = map[int32][]external.ArgMeta{
	...
	OldstatEventID:                {{Type: "const char*", Name: "pathname"}, {Type: "struct stat*", Name: "statbuf"}},
	...
	Lchown16EventID:               {{Type: "const char*", Name: "pathname"}, {Type: "uid_t", Name: "owner"}, {Type: "gid_t", Name: "group"}},
	Getuid16EventID:               {},
	Getgid16EventID:               {},
	Geteuid16EventID:              {},
	Getegid16EventID:              {},
	Setreuid16EventID:             {{Type: "uid_t", Name: "ruid"}, {Type: "uid_t", Name: "euid"}},
	Setregid16EventID:             {{Type: "gid_t", Name: "rgid"}, {Type: "gid_t", Name: "egid"}},
	Getgroups16EventID:            {{Type: "int", Name: "size"}, {Type: "gid_t*", Name: "list"}},
	Setgroups16EventID:            {{Type: "size_t", Name: "size"}, {Type: "const gid_t*", Name: "list"}},
	Fchown16EventID:               {{Type: "const char*", Name: "pathname"}, {Type: "uid_t", Name: "owner"}, {Type: "gid_t", Name: "group"}},
	Setresuid16EventID:            {{Type: "uid_t", Name: "ruid"}, {Type: "uid_t", Name: "euid"}, {Type: "uid_t", Name: "suid"}},
	Getresuid16EventID:            {{Type: "uid_t*", Name: "ruid"}, {Type: "uid_t*", Name: "euid"}, {Type: "uid_t*", Name: "suid"}},
	Setresgid16EventID:            {{Type: "uid_t", Name: "ruid"}, {Type: "uid_t", Name: "euid"}, {Type: "uid_t", Name: "suid"}},
	Getresgid16EventID:            {{Type: "uid_t*", Name: "ruid"}, {Type: "uid_t*", Name: "euid"}, {Type: "uid_t*", Name: "suid"}},
	Chown16EventID:                {{Type: "const char*", Name: "pathname"}, {Type: "uid_t", Name: "owner"}, {Type: "gid_t", Name: "group"}},
	Setuid16EventID:               {{Type: "uid_t", Name: "uid"}},
	Setgid16EventID:               {{Type: "gid_t", Name: "gid"}},
	Setfsuid16EventID:             {{Type: "uid_t", Name: "fsuid"}},
	Setfsgid16EventID:             {{Type: "gid_t", Name: "fsgid"}},
