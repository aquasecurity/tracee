...
var EventsIDToEvent = map[int32]EventConfig{
	...
	NewselectEventID:                    {ID: NewselectEventID, ID32Bit: sys32_newselect, Name: "newselect", Probes: []probe{{event: "newselect", attach: sysCall, fn: "newselect"}}, Sets: []string{"syscalls", "32bit_unique"}},
	...
	UgetrlimitEventID:                   {ID: UgetrlimitEventID, ID32Bit: sys32ugetrlimit, Name: "ugetrlimit", Probes: []probe{{event: "ugetrlimit", attach: sysCall, fn: "ugetrlimit"}}, Sets: []string{"syscalls", "32bit_unique"}},
	...
	Lchown32EventID:                     {ID: Lchown32EventID, ID32Bit: sys32lchown32, Name: "lchown32", Probes: []probe{{event: "lchown32", attach: sysCall, fn: "lchown32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Getuid32EventID:                     {ID: Getuid32EventID, ID32Bit: sys32getuid32, Name: "getuid32", Probes: []probe{{event: "getuid32", attach: sysCall, fn: "getuid32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Getgid32EventID:                     {ID: Getgid32EventID, ID32Bit: sys32getgid32, Name: "getgid32", Probes: []probe{{event: "getgid32", attach: sysCall, fn: "getgid32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Geteuid32EventID:                    {ID: Geteuid32EventID, ID32Bit: sys32geteuid32, Name: "geteuid32", Probes: []probe{{event: "geteuid32", attach: sysCall, fn: "geteuid32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Getegid32EventID:                    {ID: Getegid32EventID, ID32Bit: sys32getegid32, Name: "getegid32", Probes: []probe{{event: "getegid32", attach: sysCall, fn: "getegid32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setreuid32EventID:                   {ID: Setreuid32EventID, ID32Bit: sys32setreuid32, Name: "setreuid32", Probes: []probe{{event: "setreuid32", attach: sysCall, fn: "setreuid32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setregid32EventID:                   {ID: Setregid32EventID, ID32Bit: sys32setregid32, Name: "setregid32", Probes: []probe{{event: "setregid32", attach: sysCall, fn: "setregid32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Getgroups32EventID:                  {ID: Getgroups32EventID, ID32Bit: sys32getgroups32, Name: "getgroups32", Probes: []probe{{event: "getgroups32", attach: sysCall, fn: "getgroups32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setgroups32EventID:                  {ID: Setgroups32EventID, ID32Bit: sys32setgroups32, Name: "setgroups32", Probes: []probe{{event: "setgroups32", attach: sysCall, fn: "setgroups32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Fchown32EventID:                     {ID: Fchown32EventID, ID32Bit: sys32fchown32, Name: "fchown32", Probes: []probe{{event: "fchown32", attach: sysCall, fn: "fchown32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setresuid32EventID:                  {ID: Setresuid32EventID, ID32Bit: sys32setresuid32, Name: "setresuid32", Probes: []probe{{event: "setresuid32", attach: sysCall, fn: "setresuid32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Getresuid32EventID:                  {ID: Getresuid32EventID, ID32Bit: sys32getresuid32, Name: "getresuid32", Probes: []probe{{event: "getresuid32", attach: sysCall, fn: "getresuid32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setresgid32EventID:                  {ID: Setresgid32EventID, ID32Bit: sys32setresgid32, Name: "setresgid32", Probes: []probe{{event: "setresgid32", attach: sysCall, fn: "setresgid32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Getresgid32EventID:                  {ID: Getresgid32EventID, ID32Bit: sys32getresgid32, Name: "getresgid32", Probes: []probe{{event: "getresgid32", attach: sysCall, fn: "getresgid32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Chown32EventID:                      {ID: Chown32EventID, ID32Bit: sys32chown32, Name: "chown32", Probes: []probe{{event: "chown32", attach: sysCall, fn: "chown32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setuid32EventID:                     {ID: Setuid32EventID, ID32Bit: sys32setuid32, Name: "setuid32", Probes: []probe{{event: "setuid32", attach: sysCall, fn: "setuid32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setgid32EventID:                     {ID: Setgid32EventID, ID32Bit: sys32setgid32, Name: "setgid32", Probes: []probe{{event: "setgid32", attach: sysCall, fn: "setgid32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setfsuid32EventID:                   {ID: Setfsuid32EventID, ID32Bit: sys32setfsuid32, Name: "setfsuid32", Probes: []probe{{event: "setfsuid32", attach: sysCall, fn: "setfsuid32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setfsgid32EventID:                   {ID: Setfsgid32EventID, ID32Bit: sys32setfsgid32, Name: "setfsgid32", Probes: []probe{{event: "setfsgid32", attach: sysCall, fn: "setfsgid32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	...
	Sendfile64EventID:                   {ID: Sendfile64EventID, ID32Bit: sys32sendfile64, Name: "sendfile64", Probes: []probe{{event: "sendfile64", attach: sysCall, fn: "sendfile64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	...
	Clock_gettime64EventID:              {ID: Clock_gettime64EventID, ID32Bit: sys32clock_gettime64, Name: "clock_gettime64", Probes: []probe{{event: "clock_gettime64", attach: sysCall, fn: "clock_gettime64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Clock_settime64EventID:              {ID: Clock_settime64EventID, ID32Bit: sys32clock_settime64, Name: "clock_settime64", Probes: []probe{{event: "clock_settime64", attach: sysCall, fn: "clock_settime64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	...
	Clock_getres_time64EventID:          {ID: Clock_getres_time64EventID, ID32Bit: sys32clock_getres_time64, Name: "clock_getres_time64", Probes: []probe{{event: "clock_getres_time64", attach: sysCall, fn: "clock_getres_time64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Clock_nanosleep_time64EventID:       {ID: Clock_nanosleep_time64EventID, ID32Bit: sys32clock_nanosleep_time64, Name: "clock_nanosleep_time64", Probes: []probe{{event: "clock_nanosleep_time64", attach: sysCall, fn: "clock_nanosleep_time64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Timer_gettime64EventID:              {ID: Timer_gettime64EventID, ID32Bit: sys32timer_gettime64, Name: "timer_gettime64", Probes: []probe{{event: "timer_gettime64", attach: sysCall, fn: "timer_gettime64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Timer_settime64EventID:              {ID: Timer_settime64EventID, ID32Bit: sys32timer_settime64, Name: "timer_settime64", Probes: []probe{{event: "timer_settime64", attach: sysCall, fn: "timer_settime64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Timerfd_gettime64EventID:            {ID: Timerfd_gettime64EventID, ID32Bit: sys32timerfd_gettime64, Name: "timerfd_gettime64", Probes: []probe{{event: "timerfd_gettime64", attach: sysCall, fn: "timerfd_gettime64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Timerfd_settime64EventID:            {ID: Timerfd_settime64EventID, ID32Bit: sys32timerfd_settime64, Name: "timerfd_settime64", Probes: []probe{{event: "timerfd_settime64", attach: sysCall, fn: "timerfd_settime64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Utimensat_time64EventID:             {ID: Utimensat_time64EventID, ID32Bit: sys32utimensat_time64, Name: "utimensat_time64", Probes: []probe{{event: "utimensat_time64", attach: sysCall, fn: "utimensat_time64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Pselect6_time64EventID:              {ID: Pselect6_time64EventID, ID32Bit: sys32pselect6_time64, Name: "pselect6_time64", Probes: []probe{{event: "pselect6_time64", attach: sysCall, fn: "pselect6_time64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Ppoll_time64EventID:                 {ID: Ppoll_time64EventID, ID32Bit: sys32ppoll_time64, Name: "ppoll_time64", Probes: []probe{{event: "ppoll_time64", attach: sysCall, fn: "ppoll_time64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Io_pgetevents_time64EventID:         {ID: Io_pgetevents_time64EventID, ID32Bit: sys32io_pgetevents_time64, Name: "io_pgetevents_time64", Probes: []probe{{event: "io_pgetevents_time64", attach: sysCall, fn: "io_pgetevents_time64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Recvmmsg_time64EventID:              {ID: Recvmmsg_time64EventID, ID32Bit: sys32recvmmsg_time64, Name: "recvmmsg_time64", Probes: []probe{{event: "recvmmsg_time64", attach: sysCall, fn: "recvmmsg_time64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Mq_timedsend_time64EventID:          {ID: Mq_timedsend_time64EventID, ID32Bit: sys32mq_timedsend_time64, Name: "mq_timedsend_time64", Probes: []probe{{event: "mq_timedsend_time64", attach: sysCall, fn: "mq_timedsend_time64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Mq_timedreceive_time64EventID:       {ID: Mq_timedreceive_time64EventID, ID32Bit: sys32mq_timedreceive_time64, Name: "mq_timedreceive_time64", Probes: []probe{{event: "mq_timedreceive_time64", attach: sysCall, fn: "mq_timedreceive_time64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Rt_sigtimedwait_time64EventID:       {ID: Rt_sigtimedwait_time64EventID, ID32Bit: sys32rt_sigtimedwait_time64, Name: "rt_sigtimedwait_time64", Probes: []probe{{event: "rt_sigtimedwait_time64", attach: sysCall, fn: "rt_sigtimedwait_time64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Futex_time64EventID:                 {ID: Futex_time64EventID, ID32Bit: sys32futex_time64, Name: "futex_time64", Probes: []probe{{event: "futex_time64", attach: sysCall, fn: "futex_time64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Sched_rr_get_interval_time64EventID: {ID: Sched_rr_get_interval_time64EventID, ID32Bit: sys32sched_rr_get_interval_time64, Name: "sched_rr_get_interval_time64", Probes: []probe{{event: "sched_rr_get_interval_time64", attach: sysCall, fn: "sched_rr_get_interval_time64"}}, Sets: []string{"syscalls", "32bit_unique"}},
}
...
var EventsIDToParams = map[int32][]external.ArgMeta{
	...
	NewselectEventID:              {{Type: "int", Name: "nfds"}, {Type: "fd_set*", Name: "readfds"}, {Type: "fd_set*", Name: "writefds"}, {Type: "fd_set*", Name: "exceptfds"}, {Type: "struct timeval*", Name: "timeout"}},
	Vm86EventID:                   {{Type: "unsigned long", Name: "fn"}, {Type: "struct vm86plus_struct*", Name: "v86"}},
	UgetrlimitEventID:             {{Type: "int", Name: "resource"}, {Type: "struct rlimit*", Name: "rlim"}},
	...
	Lchown32EventID:               {{Type: "const char*", Name: "pathname"}, {Type: "uid_t", Name: "owner"}, {Type: "gid_t", Name: "group"}},
	Getuid32EventID:               {},
	Getgid32EventID:               {},
	Geteuid32EventID:              {},
	Getegid32EventID:              {},
	Setreuid32EventID:             {{Type: "uid_t", Name: "ruid"}, {Type: "uid_t", Name: "euid"}},
	Setregid32EventID:             {{Type: "gid_t", Name: "rgid"}, {Type: "gid_t", Name: "egid"}},
	Getgroups32EventID:            {{Type: "int", Name: "size"}, {Type: "gid_t*", Name: "list"}},
	Setgroups32EventID:            {{Type: "size_t", Name: "size"}, {Type: "const gid_t*", Name: "list"}},
	Fchown32EventID:               {{Type: "const char*", Name: "pathname"}, {Type: "uid_t", Name: "owner"}, {Type: "gid_t", Name: "group"}},
	Setresuid32EventID:            {{Type: "uid_t", Name: "ruid"}, {Type: "uid_t", Name: "euid"}, {Type: "uid_t", Name: "suid"}},
	Getresuid32EventID:            {{Type: "uid_t*", Name: "ruid"}, {Type: "uid_t*", Name: "euid"}, {Type: "uid_t*", Name: "suid"}},
	Setresgid32EventID:            {{Type: "uid_t", Name: "ruid"}, {Type: "uid_t", Name: "euid"}, {Type: "uid_t", Name: "suid"}},
	Getresgid32EventID:            {{Type: "uid_t*", Name: "ruid"}, {Type: "uid_t*", Name: "euid"}, {Type: "uid_t*", Name: "suid"}},
	Chown32EventID:                {{Type: "const char*", Name: "pathname"}, {Type: "uid_t", Name: "owner"}, {Type: "gid_t", Name: "group"}},
	Setuid32EventID:               {{Type: "uid_t", Name: "uid"}},
	Setgid32EventID:               {{Type: "gid_t", Name: "gid"}},
	Setfsuid32EventID:             {{Type: "uid_t", Name: "fsuid"}},
	Setfsgid32EventID:             {{Type: "gid_t", Name: "fsgid"}},
	Fcntl64EventID:                {{Type: "int", Name: "fd"}, {Type: "int", Name: "cmd"}, {Type: "unsigned long", Name: "arg"}},
	Sendfile64EventID:             {{Type: "int", Name: "out_fd"}, {Type: "int", Name: "in_fd"}, {Type: "off_t*", Name: "offset"}, {Type: "size_t", Name: "count"}},
