...
var EventsIDToEvent = map[int32]EventConfig{
	...
	SetuidEventID:                   {ID: SetuidEventID, ID32Bit: sys32setuid32, Name: "setuid", Probes: []probe{{event: "setuid", attach: sysCall, fn: "setuid"}}, Sets: []string{"default", "syscalls", "proc", "proc_ids"}},
	...
	SetfsuidEventID:                 {ID: SetfsuidEventID, ID32Bit: sys32setfsuid32, Name: "setfsuid", Probes: []probe{{event: "setfsuid", attach: sysCall, fn: "setfsuid"}}, Sets: []string{"default", "syscalls", "proc", "proc_ids"}},
	SetfsgidEventID:                 {ID: SetfsgidEventID, ID32Bit: sys32setfsgid32, Name: "setfsgid", Probes: []probe{{event: "setfsgid", attach: sysCall, fn: "setfsgid"}}, Sets: []string{"default", "syscalls", "proc", "proc_ids"}},
	...
	OldstatEventID:                  {ID: OldfstatEventID, ID32Bit: sys32oldstat, Name: "oldstat", Probes: []probe{{event: "oldstat", attach: sysCall, fn: "oldstat"}}, Sets: []string{"syscalls", "32bit_unique"}},
	...
	ClockGettime32EventID:           {ID: ClockGettime32EventID, ID32Bit: sys32clock_gettime, Name: "clock_gettime32", Probes: []probe{{event: "clock_gettime32", attach: sysCall, fn: "clock_gettime32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	ClockSettime32EventID:           {ID: ClockSettime32EventID, ID32Bit: sys32clock_settime, Name: "clock_settime32", Probes: []probe{{event: "clock_settime32", attach: sysCall, fn: "clock_settime32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	ClockAdjtime64EventID:           {ID: ClockAdjtime64EventID, ID32Bit: sys32clock_adjtime64, Name: "clock_adjtime64", Probes: []probe{{event: "clock_adjtime64", attach: sysCall, fn: "clock_adjtime64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	ClockGetresTime32EventID:        {ID: ClockGetresTime32EventID, ID32Bit: sys32clock_getres, Name: "clock_getres_time32", Probes: []probe{{event: "clock_getres_time32", attach: sysCall, fn: "clock_getres_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	ClockNanosleepTime32EventID:     {ID: ClockNanosleepTime32EventID, ID32Bit: sys32clock_nanosleep, Name: "clock_nanosleep_time32", Probes: []probe{{event: "clock_nanosleep_time32", attach: sysCall, fn: "clock_nanosleep_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	TimerGettime32EventID:           {ID: TimerGettime32EventID, ID32Bit: sys32timer_gettime, Name: "timer_gettime32", Probes: []probe{{event: "timer_gettime32", attach: sysCall, fn: "timer_gettime32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	TimerSettime32EventID:           {ID: TimerSettime32EventID, ID32Bit: sys32timer_settime, Name: "timer_settime32", Probes: []probe{{event: "timer_settime32", attach: sysCall, fn: "timer_settime32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	TimerfdGettime32EventID:         {ID: TimerfdGettime32EventID, ID32Bit: sys32timerfd_gettime, Name: "timerfd_gettime32", Probes: []probe{{event: "timerfd_gettime32", attach: sysCall, fn: "timerfd_gettime32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	TimerfdSettime32EventID:         {ID: TimerfdSettime32EventID, ID32Bit: sys32timerfd_settime, Name: "timerfd_settime32", Probes: []probe{{event: "timerfd_settime32", attach: sysCall, fn: "timerfd_settime32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	UtimensatTime32EventID:          {ID: UtimensatTime32EventID, ID32Bit: sys32utimensat, Name: "utimensat_time32", Probes: []probe{{event: "utimensat_time32", attach: sysCall, fn: "utimensat_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Pselect6Time32EventID:           {ID: Pselect6Time32EventID, ID32Bit: sys32pselect6, Name: "pselect6_time32", Probes: []probe{{event: "pselect6_time32", attach: sysCall, fn: "pselect6_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	PpollTime32EventID:              {ID: PpollTime32EventID, ID32Bit: sys32ppoll, Name: "ppoll_time32", Probes: []probe{{event: "ppoll_time32", attach: sysCall, fn: "ppoll_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	IoPgeteventsTime32EventID:       {ID: IoPgeteventsTime32EventID, ID32Bit: sys32io_pgetevents, Name: "io_pgetevents_time32", Probes: []probe{{event: "io_pgetevents_time32", attach: sysCall, fn: "io_pgetevents_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	RecvmmsgTime32EventID:           {ID: RecvmmsgTime32EventID, ID32Bit: sys32recvmmsg, Name: "recvmmsg_time32", Probes: []probe{{event: "recvmmsg_time32", attach: sysCall, fn: "recvmmsg_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	MqTimedsendTime32EventID:        {ID: MqTimedsendTime32EventID, ID32Bit: sys32mq_timedsend, Name: "mq_timedsend_time32", Probes: []probe{{event: "mq_timedsend_time32", attach: sysCall, fn: "mq_timedsend_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	MqTimedreceiveTime32EventID:     {ID: MqTimedreceiveTime32EventID, ID32Bit: sys32mq_timedreceive, Name: "mq_timedreceive_time32", Probes: []probe{{event: "mq_timedreceive_time32", attach: sysCall, fn: "mq_timedreceive_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	...
	SchedRrGetIntervalTime32EventID: {ID: SchedRrGetIntervalTime32EventID, ID32Bit: sys32sched_rr_get_interval, Name: "sched_rr_get_interval_time32", Probes: []probe{{event: "sched_rr_get_interval_time32", attach: sysCall, fn: "sched_rr_get_interval_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
}
...
var EventsIDToParams = map[int32][]external.ArgMeta{
	...
	SchedRrGetIntervalTime32EventID: {{Type: "pid_t", Name: "pid"}, {Type: "struct old_timespec32*", Name: "interval"}},
