...
var EventsIDToEvent = map[int32]EventConfig{
	...
	SelectEventID:                       {ID: SelectEventID, ID32Bit: sys32_newselect, Name: "select", Probes: []probe{{event: "select", attach: sysCall, fn: "select"}}, Sets: []string{"syscalls", "fs", "fs_mux_io"}},
	...
	SendfileEventID:                     {ID: SendfileEventID, ID32Bit: sys32sendfile64, Name: "sendfile", Probes: []probe{{event: "sendfile", attach: sysCall, fn: "sendfile"}}, Sets: []string{"syscalls", "fs", "fs_read_write"}},
	...
	ChownEventID:                        {ID: ChownEventID, ID32Bit: sys32chown32, Name: "chown", Probes: []probe{{event: "chown", attach: sysCall, fn: "chown"}}, Sets: []string{"default", "syscalls", "fs", "fs_file_attr"}},
	FchownEventID:                       {ID: FchownEventID, ID32Bit: sys32fchown32, Name: "fchown", Probes: []probe{{event: "fchown", attach: sysCall, fn: "fchown"}}, Sets: []string{"default", "syscalls", "fs", "fs_file_attr"}},
	LchownEventID:                       {ID: LchownEventID, ID32Bit: sys32lchown32, Name: "lchown", Probes: []probe{{event: "lchown", attach: sysCall, fn: "lchown"}}, Sets: []string{"default", "syscalls", "fs", "fs_file_attr"}},
	...
	GetrlimitEventID:                    {ID: GetrlimitEventID, ID32Bit: sys32ugetrlimit, Name: "getrlimit", Probes: []probe{{event: "getrlimit", attach: sysCall, fn: "getrlimit"}}, Sets: []string{"syscalls", "proc"}},
	...
	GetuidEventID:                       {ID: GetuidEventID, ID32Bit: sys32getuid32, Name: "getuid", Probes: []probe{{event: "getuid", attach: sysCall, fn: "getuid"}}, Sets: []string{"syscalls", "proc", "proc_ids"}},
	...
	GetgidEventID:                       {ID: GetgidEventID, ID32Bit: sys32getgid32, Name: "getgid", Probes: []probe{{event: "getgid", attach: sysCall, fn: "getgid"}}, Sets: []string{"syscalls", "proc", "proc_ids"}},
	...
	SetgidEventID:                       {ID: SetgidEventID, ID32Bit: sys32setgid32, Name: "setgid", Probes: []probe{{event: "setgid", attach: sysCall, fn: "setgid"}}, Sets: []string{"default", "syscalls", "proc", "proc_ids"}},
	GeteuidEventID:                      {ID: GeteuidEventID, ID32Bit: sys32geteuid32, Name: "geteuid", Probes: []probe{{event: "geteuid", attach: sysCall, fn: "geteuid"}}, Sets: []string{"syscalls", "proc", "proc_ids"}},
	GetegidEventID:                      {ID: GetegidEventID, ID32Bit: sys32getegid32, Name: "getegid", Probes: []probe{{event: "getegid", attach: sysCall, fn: "getegid"}}, Sets: []string{"syscalls", "proc", "proc_ids"}},
	...
	SetreuidEventID:                     {ID: SetreuidEventID, ID32Bit: sys32setreuid32, Name: "setreuid", Probes: []probe{{event: "setreuid", attach: sysCall, fn: "setreuid"}}, Sets: []string{"default", "syscalls", "proc", "proc_ids"}},
	SetregidEventID:                     {ID: SetregidEventID, ID32Bit: sys32setregid32, Name: "setregid", Probes: []probe{{event: "setregid", attach: sysCall, fn: "setregid"}}, Sets: []string{"default", "syscalls", "proc", "proc_ids"}},
	GetgroupsEventID:                    {ID: GetgroupsEventID, ID32Bit: sys32getgroups32, Name: "getgroups", Probes: []probe{{event: "getgroups", attach: sysCall, fn: "getgroups"}}, Sets: []string{"syscalls", "proc", "proc_ids"}},
	SetgroupsEventID:                    {ID: SetgroupsEventID, ID32Bit: sys32setgroups32, Name: "setgroups", Probes: []probe{{event: "setgroups", attach: sysCall, fn: "setgroups"}}, Sets: []string{"syscalls", "proc", "proc_ids"}},
	SetresuidEventID:                    {ID: SetresuidEventID, ID32Bit: sys32setresuid32, Name: "setresuid", Probes: []probe{{event: "setresuid", attach: sysCall, fn: "setresuid"}}, Sets: []string{"syscalls", "proc", "proc_ids"}},
	GetresuidEventID:                    {ID: GetresuidEventID, ID32Bit: sys32getresuid32, Name: "getresuid", Probes: []probe{{event: "getresuid", attach: sysCall, fn: "getresuid"}}, Sets: []string{"syscalls", "proc", "proc_ids"}},
	SetresgidEventID:                    {ID: SetresgidEventID, ID32Bit: sys32setresgid32, Name: "setresgid", Probes: []probe{{event: "setresgid", attach: sysCall, fn: "setresgid"}}, Sets: []string{"syscalls", "proc", "proc_ids"}},
	GetresgidEventID:                    {ID: GetresgidEventID, ID32Bit: sys32getresgid32, Name: "getresgid", Probes: []probe{{event: "getresgid", attach: sysCall, fn: "getresgid"}}, Sets: []string{"syscalls", "proc", "proc_ids"}},
	...
	RtSigtimedwaitEventID:               {ID: RtSigtimedwaitEventID, ID32Bit: sys32rt_sigtimedwait_time64, Name: "rt_sigtimedwait", Probes: []probe{{event: "rt_sigtimedwait", attach: sysCall, fn: "rt_sigtimedwait"}}, Sets: []string{"syscalls", "signals"}},
	...
	SchedRrGetIntervalEventID:           {ID: SchedRrGetIntervalEventID, ID32Bit: sys32sched_rr_get_interval_time64, Name: "sched_rr_get_interval", Probes: []probe{{event: "sched_rr_get_interval", attach: sysCall, fn: "sched_rr_get_interval"}}, Sets: []string{"syscalls", "proc", "proc_sched"}},
	...
	SysctlEventID:                       {ID: SysctlEventID, ID32Bit: sys32_sysctl, Name: "sysctl", Probes: []probe{{event: "sysctl", attach: sysCall, fn: "sysctl"}}, Sets: []string{"syscalls", "system"}},
	...
	FutexEventID:                        {ID: FutexEventID, ID32Bit: sys32futex_time64, Name: "futex", Probes: []probe{{event: "futex", attach: sysCall, fn: "futex"}}, Sets: []string{"syscalls", "ipc", "ipc_futex"}},
	...
	TimerSettimeEventID:                 {ID: TimerSettimeEventID, ID32Bit: sys32timer_settime64, Name: "timer_settime", Probes: []probe{{event: "timer_settime", attach: sysCall, fn: "timer_settime"}}, Sets: []string{"syscalls", "time", "time_timer"}},
	TimerGettimeEventID:                 {ID: TimerGettimeEventID, ID32Bit: sys32timer_gettime64, Name: "timer_gettime", Probes: []probe{{event: "timer_gettime", attach: sysCall, fn: "timer_gettime"}}, Sets: []string{"syscalls", "time", "time_timer"}},
	...
	ClockSettimeEventID:                 {ID: ClockSettimeEventID, ID32Bit: sys32clock_settime64, Name: "clock_settime", Probes: []probe{{event: "clock_settime", attach: sysCall, fn: "clock_settime"}}, Sets: []string{"syscalls", "time", "time_clock"}},
	ClockGettimeEventID:                 {ID: ClockGettimeEventID, ID32Bit: sys32clock_gettime64, Name: "clock_gettime", Probes: []probe{{event: "clock_gettime", attach: sysCall, fn: "clock_gettime"}}, Sets: []string{"syscalls", "time", "time_clock"}},
	ClockGetresEventID:                  {ID: ClockGetresEventID, ID32Bit: sys32clock_getres_time64, Name: "clock_getres", Probes: []probe{{event: "clock_getres", attach: sysCall, fn: "clock_getres"}}, Sets: []string{"syscalls", "time", "time_clock"}},
	ClockNanosleepEventID:               {ID: ClockNanosleepEventID, ID32Bit: sys32clock_nanosleep_time64, Name: "clock_nanosleep", Probes: []probe{{event: "clock_nanosleep", attach: sysCall, fn: "clock_nanosleep"}}, Sets: []string{"syscalls", "time", "time_clock"}},
	...
	MqTimedsendEventID:                  {ID: MqTimedsendEventID, ID32Bit: sys32mq_timedsend_time64, Name: "mq_timedsend", Probes: []probe{{event: "mq_timedsend", attach: sysCall, fn: "mq_timedsend"}}, Sets: []string{"syscalls", "ipc", "ipc_msgq"}},
	MqTimedreceiveEventID:               {ID: MqTimedreceiveEventID, ID32Bit: sys32mq_timedreceive_time64, Name: "mq_timedreceive", Probes: []probe{{event: "mq_timedreceive", attach: sysCall, fn: "mq_timedreceive"}}, Sets: []string{"syscalls", "ipc", "ipc_msgq"}},
	...
	Pselect6EventID:                     {ID: Pselect6EventID, ID32Bit: sys32pselect6_time64, Name: "pselect6", Probes: []probe{{event: "pselect6", attach: sysCall, fn: "pselect6"}}, Sets: []string{"syscalls", "fs", "fs_mux_io"}},
	PpollEventID:                        {ID: PpollEventID, ID32Bit: sys32ppoll_time64, Name: "ppoll", Probes: []probe{{event: "ppoll", attach: sysCall, fn: "ppoll"}}, Sets: []string{"syscalls", "fs", "fs_mux_io"}},
	...
	UtimensatEventID:                    {ID: UtimensatEventID, ID32Bit: sys32utimensat_time64, Name: "utimensat", Probes: []probe{{event: "utimensat", attach: sysCall, fn: "utimensat"}}, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	...
	TimerfdSettimeEventID:               {ID: TimerfdSettimeEventID, ID32Bit: sys32timerfd_settime64, Name: "timerfd_settime", Probes: []probe{{event: "timerfd_settime", attach: sysCall, fn: "timerfd_settime"}}, Sets: []string{"syscalls", "time", "time_timer"}},
	TimerfdGettimeEventID:               {ID: TimerfdGettimeEventID, ID32Bit: sys32timerfd_gettime64, Name: "timerfd_gettime", Probes: []probe{{event: "timerfd_gettime", attach: sysCall, fn: "timerfd_gettime"}}, Sets: []string{"syscalls", "time", "time_timer"}},
	...
	RecvmmsgEventID:                     {ID: RecvmmsgEventID, ID32Bit: sys32recvmmsg_time64, Name: "recvmmsg", Probes: []probe{{event: "recvmmsg", attach: sysCall, fn: "recvmmsg"}}, Sets: []string{"syscalls", "net", "net_snd_rcv"}},
	...
	IoPgeteventsEventID:                 {ID: IoPgeteventsEventID, ID32Bit: sys32io_pgetevents_time64, Name: "io_pgetevents", Probes: []probe{{event: "io_pgetevents", attach: sysCall, fn: "io_pgetevents"}}, Sets: []string{"syscalls", "fs", "fs_async_io"}},
	...
	WaitpidEventID:                      {ID: WaitpidEventID, ID32Bit: sys32waitpid, Name: "waitpid", Probes: []probe{{event: "waitpid", attach: sysCall, fn: "waitpid"}}, Sets: []string{"syscalls", "32bit_unique"}},
	BreakEventID:                        {ID: BreakEventID, ID32Bit: sys32break, Name: "break", Probes: []probe{{event: "break", attach: sysCall, fn: "break"}}, Sets: []string{"syscalls", "32bit_unique"}},
	OldfstatEventID:                     {ID: OldfstatEventID, ID32Bit: sys32oldfstat, Name: "oldfstat", Probes: []probe{{event: "oldfstat", attach: sysCall, fn: "oldfstat"}}, Sets: []string{"syscalls", "32bit_unique"}},
	UmountEventID:                       {ID: UmountEventID, ID32Bit: sys32umount, Name: "umount", Probes: []probe{{event: "umount", attach: sysCall, fn: "umount"}}, Sets: []string{"syscalls", "32bit_unique"}},
	StimeEventID:                        {ID: StimeEventID, ID32Bit: sys32stime, Name: "stime", Probes: []probe{{event: "stime", attach: sysCall, fn: "stime"}}, Sets: []string{"syscalls", "32bit_unique"}},
	SttyEventID:                         {ID: SttyEventID, ID32Bit: sys32stty, Name: "stty", Probes: []probe{{event: "stty", attach: sysCall, fn: "stty"}}, Sets: []string{"syscalls", "32bit_unique"}},
	GttyEventID:                         {ID: GttyEventID, ID32Bit: sys32gtty, Name: "gtty", Probes: []probe{{event: "gtty", attach: sysCall, fn: "gtty"}}, Sets: []string{"syscalls", "32bit_unique"}},
	NiceEventID:                         {ID: NiceEventID, ID32Bit: sys32nice, Name: "nice", Probes: []probe{{event: "nice", attach: sysCall, fn: "nice"}}, Sets: []string{"syscalls", "32bit_unique"}},
	FtimeEventID:                        {ID: FtimeEventID, ID32Bit: sys32ftime, Name: "ftime", Probes: []probe{{event: "ftime", attach: sysCall, fn: "ftime"}}, Sets: []string{"syscalls", "32bit_unique"}},
	ProfEventID:                         {ID: ProfEventID, ID32Bit: sys32prof, Name: "prof", Probes: []probe{{event: "prof", attach: sysCall, fn: "prof"}}, Sets: []string{"syscalls", "32bit_unique"}},
	SignalEventID:                       {ID: SignalEventID, ID32Bit: sys32signal, Name: "signal", Probes: []probe{{event: "signal", attach: sysCall, fn: "signal"}}, Sets: []string{"syscalls", "32bit_unique"}},
	LockEventID:                         {ID: LockEventID, ID32Bit: sys32lock, Name: "lock", Probes: []probe{{event: "lock", attach: sysCall, fn: "lock"}}, Sets: []string{"syscalls", "32bit_unique"}},
	MpxEventID:                          {ID: MpxEventID, ID32Bit: sys32mpx, Name: "mpx", Probes: []probe{{event: "mpx", attach: sysCall, fn: "mpx"}}, Sets: []string{"syscalls", "32bit_unique"}},
	UlimitEventID:                       {ID: UlimitEventID, ID32Bit: sys32ulimit, Name: "ulimit", Probes: []probe{{event: "ulimit", attach: sysCall, fn: "ulimit"}}, Sets: []string{"syscalls", "32bit_unique"}},
	OldoldunameEventID:                  {ID: OldoldunameEventID, ID32Bit: sys32oldolduname, Name: "oldolduname", Probes: []probe{{event: "oldolduname", attach: sysCall, fn: "oldolduname"}}, Sets: []string{"syscalls", "32bit_unique"}},
	SigactionEventID:                    {ID: SigactionEventID, ID32Bit: sys32sigaction, Name: "sigaction", Probes: []probe{{event: "sigaction", attach: sysCall, fn: "sigaction"}}, Sets: []string{"syscalls", "32bit_unique"}},
	SgetmaskEventID:                     {ID: SgetmaskEventID, ID32Bit: sys32sgetmask, Name: "sgetmask", Probes: []probe{{event: "sgetmast", attach: sysCall, fn: "sgetmask"}}, Sets: []string{"syscalls", "32bit_unique"}},
	SsetmaskEventID:                     {ID: SsetmaskEventID, ID32Bit: sys32ssetmask, Name: "ssetmask", Probes: []probe{{event: "ssetmask", attach: sysCall, fn: "ssetmask"}}, Sets: []string{"syscalls", "32bit_unique"}},
	SigsuspendEventID:                   {ID: SigsuspendEventID, ID32Bit: sys32sigsuspend, Name: "sigsuspend", Probes: []probe{{event: "sigsuspend", attach: sysCall, fn: "sigsuspend"}}, Sets: []string{"syscalls", "32bit_unique"}},
	SigpendingEventID:                   {ID: SigpendingEventID, ID32Bit: sys32sigpending, Name: "sigpending", Probes: []probe{{event: "sigpending", attach: sysCall, fn: "sigpending"}}, Sets: []string{"syscalls", "32bit_unique"}},
	OldlstatEventID:                     {ID: OldlstatEventID, ID32Bit: sys32oldlstat, Name: "oldlstat", Probes: []probe{{event: "oldlstat", attach: sysCall, fn: "oldlstat"}}, Sets: []string{"syscalls", "32bit_unique"}},
	ReaddirEventID:                      {ID: ReaddirEventID, ID32Bit: sys32readdir, Name: "readdir", Probes: []probe{{event: "readdir", attach: sysCall, fn: "readdir"}}, Sets: []string{"syscalls", "32bit_unique"}},
	ProfilEventID:                       {ID: ProfilEventID, ID32Bit: sys32profil, Name: "profil", Probes: []probe{{event: "profil", attach: sysCall, fn: "profil"}}, Sets: []string{"syscalls", "32bit_unique"}},
	SocketcallEventID:                   {ID: SocketcallEventID, ID32Bit: sys32socketcall, Name: "socketcall", Probes: []probe{{event: "socketcall", attach: sysCall, fn: "socketcall"}}, Sets: []string{"syscalls", "32bit_unique"}},
	OldunameEventID:                     {ID: OldunameEventID, ID32Bit: sys32olduname, Name: "olduname", Probes: []probe{{event: "olduname", attach: sysCall, fn: "olduname"}}, Sets: []string{"syscalls", "32bit_unique"}},
	IdleEventID:                         {ID: IdleEventID, ID32Bit: sys32idle, Name: "idle", Probes: []probe{{event: "idle", attach: sysCall, fn: "idle"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Vm86oldEventID:                      {ID: Vm86oldEventID, ID32Bit: sys32vm86old, Name: "vm86old", Probes: []probe{{event: "vm86old", attach: sysCall, fn: "vm86old"}}, Sets: []string{"syscalls", "32bit_unique"}},
	IpcEventID:                          {ID: IpcEventID, ID32Bit: sys32ipc, Name: "ipc", Probes: []probe{{event: "ipc", attach: sysCall, fn: "ipc"}}, Sets: []string{"syscalls", "32bit_unique"}},
	SigreturnEventID:                    {ID: SigreturnEventID, ID32Bit: sys32sigreturn, Name: "sigreturn", Probes: []probe{{event: "sigreturn", attach: sysCall, fn: "sigreturn"}}, Sets: []string{"syscalls", "32bit_unique"}},
	SigprocmaskEventID:                  {ID: SigprocmaskEventID, ID32Bit: sys32sigprocmask, Name: "sigprocmask", Probes: []probe{{event: "sigprocmask", attach: sysCall, fn: "sigprocmask"}}, Sets: []string{"syscalls", "32bit_unique"}},
	BdflushEventID:                      {ID: BdflushEventID, ID32Bit: sys32bdflush, Name: "bdflush", Probes: []probe{{event: "bdflush", attach: sysCall, fn: "bdflush"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Afs_syscallEventID:                  {ID: Afs_syscallEventID, ID32Bit: sys32afs_syscall, Name: "afs_syscall", Probes: []probe{{event: "afs_syscall", attach: sysCall, fn: "afs_syscall"}}, Sets: []string{"syscalls", "32bit_unique"}},
	LlseekEventID:                       {ID: LlseekEventID, ID32Bit: sys32_llseek, Name: "llseek", Probes: []probe{{event: "llseek", attach: sysCall, fn: "llseek"}}, Sets: []string{"syscalls", "32bit_unique"}},
	OldSelectEventID:                    {ID: OldSelectEventID, ID32Bit: sys32select, Name: "old_select", Probes: []probe{{event: "old_select", attach: sysCall, fn: "old_select"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Vm86EventID:                         {ID: Vm86EventID, ID32Bit: sys32vm86, Name: "vm86", Probes: []probe{{event: "vm86", attach: sysCall, fn: "vm86"}}, Sets: []string{"syscalls", "32bit_unique"}},
	OldGetrlimitEventID:                 {ID: OldGetrlimitEventID, ID32Bit: sys32getrlimit, Name: "old_getrlimit", Probes: []probe{{event: "ugetrlimit", attach: sysCall, fn: "ugetrlimit"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Mmap2EventID:                        {ID: Mmap2EventID, ID32Bit: sys32mmap2, Name: "mmap2", Probes: []probe{{event: "mmap2", attach: sysCall, fn: "mmap2"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Truncate64EventID:                   {ID: Truncate64EventID, ID32Bit: sys32truncate64, Name: "truncate64", Probes: []probe{{event: "truncate64", attach: sysCall, fn: "truncate64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Ftruncate64EventID:                  {ID: Ftruncate64EventID, ID32Bit: sys32ftruncate64, Name: "ftruncate64", Probes: []probe{{event: "ftruncate64", attach: sysCall, fn: "ftruncate64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Stat64EventID:                       {ID: Stat64EventID, ID32Bit: sys32stat64, Name: "stat64", Probes: []probe{{event: "stat64", attach: sysCall, fn: "stat64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Lstat64EventID:                      {ID: Lstat64EventID, ID32Bit: sys32lstat64, Name: "lstat64", Probes: []probe{{event: "lstat64", attach: sysCall, fn: "lstat64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Fstat64EventID:                      {ID: Fstat64EventID, ID32Bit: sys32fstat64, Name: "fstat64", Probes: []probe{{event: "fstat64", attach: sysCall, fn: "fstat64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Lchown16EventID:                     {ID: Lchown16EventID, ID32Bit: sys32lchown, Name: "lchown16", Probes: []probe{{event: "lchown16", attach: sysCall, fn: "lchown16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Getuid16EventID:                     {ID: Getuid16EventID, ID32Bit: sys32getuid, Name: "getuid16", Probes: []probe{{event: "getuid16", attach: sysCall, fn: "getuid16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Getgid16EventID:                     {ID: Getgid16EventID, ID32Bit: sys32getgid, Name: "getgid16", Probes: []probe{{event: "getgid16", attach: sysCall, fn: "getgid16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Geteuid16EventID:                    {ID: Geteuid16EventID, ID32Bit: sys32geteuid, Name: "geteuid16", Probes: []probe{{event: "geteuid16", attach: sysCall, fn: "geteuid16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Getegid16EventID:                    {ID: Getegid16EventID, ID32Bit: sys32getegid, Name: "getegid16", Probes: []probe{{event: "getegid16", attach: sysCall, fn: "getegid16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setreuid16EventID:                   {ID: Setreuid16EventID, ID32Bit: sys32setreuid, Name: "setreuid16", Probes: []probe{{event: "setreuid16", attach: sysCall, fn: "setreuid16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setregid16EventID:                   {ID: Setregid16EventID, ID32Bit: sys32setregid, Name: "setregid16", Probes: []probe{{event: "setregid16", attach: sysCall, fn: "setregid16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Getgroups16EventID:                  {ID: Getgroups16EventID, ID32Bit: sys32getgroups, Name: "getgroups16", Probes: []probe{{event: "getgroups16", attach: sysCall, fn: "getgroups16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setgroups16EventID:                  {ID: Setgroups16EventID, ID32Bit: sys32setgroups, Name: "setgroups16", Probes: []probe{{event: "setgroups16", attach: sysCall, fn: "setgroups16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Fchown16EventID:                     {ID: Fchown16EventID, ID32Bit: sys32fchown, Name: "fchown16", Probes: []probe{{event: "fchown16", attach: sysCall, fn: "fchown16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setresuid16EventID:                  {ID: Setresuid16EventID, ID32Bit: sys32setresuid, Name: "setresuid16", Probes: []probe{{event: "setresuid16", attach: sysCall, fn: "setresuid16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Getresuid16EventID:                  {ID: Getresuid16EventID, ID32Bit: sys32getresuid, Name: "getresuid16", Probes: []probe{{event: "getresuid16", attach: sysCall, fn: "getresuid16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setresgid16EventID:                  {ID: Setresgid16EventID, ID32Bit: sys32setresgid, Name: "setresgid16", Probes: []probe{{event: "setresgid16", attach: sysCall, fn: "setresgid16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Getresgid16EventID:                  {ID: Getresgid16EventID, ID32Bit: sys32getresgid, Name: "getresgid16", Probes: []probe{{event: "getresgid16", attach: sysCall, fn: "getresgid16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Chown16EventID:                      {ID: Chown16EventID, ID32Bit: sys32chown, Name: "chown16", Probes: []probe{{event: "chown16", attach: sysCall, fn: "chown16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setuid16EventID:                     {ID: Setuid16EventID, ID32Bit: sys32setuid, Name: "setuid16", Probes: []probe{{event: "setuid16", attach: sysCall, fn: "setuid16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setgid16EventID:                     {ID: Setgid16EventID, ID32Bit: sys32setgid, Name: "setgid16", Probes: []probe{{event: "setgid16", attach: sysCall, fn: "setgid16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setfsuid16EventID:                   {ID: Setfsuid16EventID, ID32Bit: sys32setfsuid, Name: "setfsuid16", Probes: []probe{{event: "setfsuid16", attach: sysCall, fn: "setfsuid16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Setfsgid16EventID:                   {ID: Setfsgid16EventID, ID32Bit: sys32setfsgid, Name: "setfsgid16", Probes: []probe{{event: "setfsgid16", attach: sysCall, fn: "setfsgid16"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Fcntl64EventID:                      {ID: Fcntl64EventID, ID32Bit: sys32fcntl64, Name: "fcntl64", Probes: []probe{{event: "fcntl64", attach: sysCall, fn: "fcntl64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Sendfile32EventID:                   {ID: Sendfile32EventID, ID32Bit: sys32sendfile, Name: "sendfile32", Probes: []probe{{event: "sendfile32", attach: sysCall, fn: "sendfile32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Statfs64EventID:                     {ID: Statfs64EventID, ID32Bit: sys32statfs64, Name: "statfs64", Probes: []probe{{event: "statfs64", attach: sysCall, fn: "statfs64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Fstatfs64EventID:                    {ID: Fstatfs64EventID, ID32Bit: sys32fstatfs64, Name: "fstatfs64", Probes: []probe{{event: "fstatfs64", attach: sysCall, fn: "fstatfs64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Fadvise64_64EventID:                 {ID: Fadvise64_64EventID, ID32Bit: sys32fadvise64_64, Name: "fadvise64_64", Probes: []probe{{event: "fadvise64_64", attach: sysCall, fn: "fadvise64_64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Clock_gettime32EventID:              {ID: Clock_gettime32EventID, ID32Bit: sys32clock_gettime, Name: "clock_gettime32", Probes: []probe{{event: "clock_gettime32", attach: sysCall, fn: "clock_gettime32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Clock_settime32EventID:              {ID: Clock_settime32EventID, ID32Bit: sys32clock_settime, Name: "clock_settime32", Probes: []probe{{event: "clock_settime32", attach: sysCall, fn: "clock_settime32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Clock_adjtime64EventID:              {ID: Clock_adjtime64EventID, ID32Bit: sys32clock_adjtime64, Name: "clock_adjtime64", Probes: []probe{{event: "clock_adjtime64", attach: sysCall, fn: "clock_adjtime64"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Clock_getres_time32EventID:          {ID: Clock_getres_time32EventID, ID32Bit: sys32clock_getres, Name: "clock_getres_time32", Probes: []probe{{event: "clock_getres_time32", attach: sysCall, fn: "clock_getres_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Clock_nanosleep_time32EventID:       {ID: Clock_nanosleep_time32EventID, ID32Bit: sys32clock_nanosleep, Name: "clock_nanosleep_time32", Probes: []probe{{event: "clock_nanosleep_time32", attach: sysCall, fn: "clock_nanosleep_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Timer_gettime32EventID:              {ID: Timer_gettime32EventID, ID32Bit: sys32timer_gettime, Name: "timer_gettime32", Probes: []probe{{event: "timer_gettime32", attach: sysCall, fn: "timer_gettime32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Timer_settime32EventID:              {ID: Timer_settime32EventID, ID32Bit: sys32timer_settime, Name: "timer_settime32", Probes: []probe{{event: "timer_settime32", attach: sysCall, fn: "timer_settime32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Timerfd_gettime32EventID:            {ID: Timerfd_gettime32EventID, ID32Bit: sys32timerfd_gettime, Name: "timerfd_gettime32", Probes: []probe{{event: "timerfd_gettime32", attach: sysCall, fn: "timerfd_gettime32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Timerfd_settime32EventID:            {ID: Timerfd_settime32EventID, ID32Bit: sys32timerfd_settime, Name: "timerfd_settime32", Probes: []probe{{event: "timerfd_settime32", attach: sysCall, fn: "timerfd_settime32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Utimensat_time32EventID:             {ID: Utimensat_time32EventID, ID32Bit: sys32utimensat, Name: "utimensat_time32", Probes: []probe{{event: "utimensat_time32", attach: sysCall, fn: "utimensat_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Pselect6_time32EventID:              {ID: Pselect6_time32EventID, ID32Bit: sys32pselect6, Name: "pselect6_time32", Probes: []probe{{event: "pselect6_time32", attach: sysCall, fn: "pselect6_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Ppoll_time32EventID:                 {ID: Ppoll_time32EventID, ID32Bit: sys32ppoll, Name: "ppoll_time32", Probes: []probe{{event: "ppoll_time32", attach: sysCall, fn: "ppoll_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Io_pgetevents_time32EventID:         {ID: Io_pgetevents_time32EventID, ID32Bit: sys32io_pgetevents, Name: "io_pgetevents_time32", Probes: []probe{{event: "io_pgetevents_time32", attach: sysCall, fn: "io_pgetevents_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Recvmmsg_time32EventID:              {ID: Recvmmsg_time32EventID, ID32Bit: sys32recvmmsg, Name: "recvmmsg_time32", Probes: []probe{{event: "recvmmsg_time32", attach: sysCall, fn: "recvmmsg_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Mq_timedsend_time32EventID:          {ID: Mq_timedsend_time32EventID, ID32Bit: sys32mq_timedsend, Name: "mq_timedsend_time32", Probes: []probe{{event: "mq_timedsend_time32", attach: sysCall, fn: "mq_timedsend_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Mq_timedreceive_time32EventID:       {ID: Mq_timedreceive_time32EventID, ID32Bit: sys32mq_timedreceive, Name: "mq_timedreceive_time32", Probes: []probe{{event: "mq_timedreceive_time32", attach: sysCall, fn: "mq_timedreceive_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Rt_sigtimedwait_time32EventID:       {ID: Rt_sigtimedwait_time32EventID, ID32Bit: sys32rt_sigtimedwait, Name: "rt_sigtimedwait_time32", Probes: []probe{{event: "rt_sigtimedwait_time32", attach: sysCall, fn: "rt_sigtimedwait_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Futex_time32EventID:                 {ID: Futex_time32EventID, ID32Bit: sys32futex, Name: "futex_time32", Probes: []probe{{event: "futex_time32", attach: sysCall, fn: "futex_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
	Sched_rr_get_interval_time32EventID: {ID: Sched_rr_get_interval_time32EventID, ID32Bit: sys32sched_rr_get_interval, Name: "sched_rr_get_interval_time32", Probes: []probe{{event: "sched_rr_get_interval_time32", attach: sysCall, fn: "sched_rr_get_interval_time32"}}, Sets: []string{"syscalls", "32bit_unique"}},
}
...
var EventsIDToParams = map[int32][]external.ArgMeta{
	...
	Pselect6_time32EventID:              {{Type: "int", Name: "n"}, {Type: "fd_set*", Name: "inp"}, {Type: "fd_set*", Name: "outp"}, {Type: "fd_set*", Name: "exp"}, {Type: "struct old_timespec32*", Name: "tsp"}, {Type: "void*", Name: "sig"}},
	Ppoll_time32EventID:                 {{Type: "struct pollfd*", Name: "ufds"}, {Type: "unsigned int", Name: "nfds"}, {Type: "struct old_timespec32*", Name: "tsp"}, {Type: "sigset_t*", Name: "sigmask"}, {Type: "size_t", Name: "sigsetsize"}},
	Timerfd_gettime32EventID:            {{Type: "int", Name: "ufd"}, {Type: "struct old_itimerspec32*", Name: "otmr"}},
	Timerfd_settime32EventID:            {{Type: "int", Name: "ufd"}, {Type: "int", Name: "flags"}, {Type: "struct old_itimerspec32*", Name: "utmr"}, {Type: "struct old_itimerspec32*", Name: "otmr"}},
	Utimensat_time32EventID:             {{Type: "unsigned int", Name: "dfd"}, {Type: "char*", Name: "filename"}, {Type: "struct old_timespec32*", Name: "t"}, {Type: "int", Name: "flags"}},
	Mq_timedsend_time32EventID:          {{Type: "mqd_t", Name: "mqdes"}, {Type: "char*", Name: "u_msg_ptr"}, {Type: "unsigned int", Name: "msg_len"}, {Type: "unsigned int", Name: "msg_prio"}, {Type: "struct old_timespec32*", Name: "u_abs_timeout"}},
	Mq_timedreceive_time32EventID:       {{Type: "mqd_t", Name: "mqdes"}, {Type: "char*", Name: "u_msg_ptr"}, {Type: "unsigned int", Name: "msg_len"}, {Type: "unsigned int*", Name: "u_msg_prio"}, {Type: "struct old_timespec32*", Name: "u_abs_timeout"}},
	Rt_sigtimedwait_time32EventID:       {{Type: "sigset_t*", Name: "uthese"}, {Type: "siginfo_t*", Name: "uinfo"}, {Type: "struct old_timespec32*", Name: "uts"}, {Type: "size_t", Name: "sigsetsize"}},
	Futex_time32EventID:                 {{Type: "u32*", Name: "uaddr"}, {Type: "int", Name: "op"}, {Type: "u32", Name: "val"}, {Type: "struct old_timespec32*", Name: "utime"}, {Type: "u32*", Name: "uaddr2"}, {Type: "u32", Name: "val3"}},
	Sched_rr_get_interval_time32EventID: {{Type: "pid_t", Name: "pid"}, {Type: "struct old_timespec32*", Name: "interval"}},
	Clock_gettime32EventID:              {{Type: "clockid_t", Name: "which_clock"}, {Type: "struct old_timespec32*", Name: "tp"}},
	Clock_settime32EventID:              {{Type: "clockid_t", Name: "which_clock"}, {Type: "struct old_timespec32*", Name: "tp"}},
	Clock_getres_time32EventID:          {{Type: "clockid_t", Name: "which_clock"}, {Type: "struct old_timespec32*", Name: "tp"}},
	Clock_nanosleep_time32EventID:       {{Type: "clockid_t", Name: "which_clock"}, {Type: "int", Name: "flags"}, {Type: "struct old_timespec32*", Name: "rqtp"}, {Type: "struct old_timespec32*", Name: "rmtp"}},
	Timer_gettime32EventID:              {{Type: "timer_t", Name: "timer_id"}, {Type: "struct old_itimerspec32*", Name: "setting"}},
	Timer_settime32EventID:              {{Type: "timer_t", Name: "timer_id"}, {Type: "int", Name: "flags"}, {Type: "struct old_itimerspec32*", Name: "new"}, {Type: "struct old_itimerspec32*", Name: "old"}},
	Recvmmsg_time32EventID:              {{Type: "int", Name: "fd"}, {Type: "struct mmsghdr*", Name: "mmsg"}, {Type: "unsigned int", Name: "vlen"}, {Type: "unsigned int", Name: "flags"}, {Type: "struct old_timespec32*", Name: "timeout"}},
