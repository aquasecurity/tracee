	...
	return detection.DetectorDefinition{
		...
		ProducedEvent: v1beta1.EventDefinition{
			...
			Fields: []*v1beta1.EventField{
				{Name: "hooked_seq_ops", Type: "map[string]trace.HookedSymbolData"},
			},
		},
...
func (d *HookedSeqOps) OnEvent(ctx context.Context, event *v1beta1.Event) ([]*v1beta1.Event, error) {
	...
	d.logger.Warnw("Network seq_ops hooks detected",
