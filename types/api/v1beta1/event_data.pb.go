...
func (x *EventValue) GetString_() *wrapperspb.StringValue {
...
type EventValue_Uint32 struct {
	Uint32 *wrapperspb.UInt32Value `protobuf:"bytes,3,opt,name=uint32,proto3,oneof"` // uintT, modeT, devT, u8T, u16T
}

type EventValue_Uint64 struct {
	Uint64 *wrapperspb.UInt64Value `protobuf:"bytes,4,opt,name=uint64,proto3,oneof"` // ulongT, offT, sizeT, pointerT
}

type EventValue_String_ struct {
	String_ *wrapperspb.StringValue `protobuf:"bytes,5,opt,name=string,proto3,oneof"` // strT
}
...
type StringArrayValue struct {
	...
	Array []*wrapperspb.StringValue `protobuf:"bytes,1,rep,name=array,proto3" json:"array,omitempty"`
}
...
func (x *StringArrayValue) GetArray() []*wrapperspb.StringValue {
	if x != nil {
		return x.Array
	}
	return nil
...
type IntArrayValue struct {
	...
	Array []*wrapperspb.Int32Value `protobuf:"bytes,1,rep,name=array,proto3" json:"array,omitempty"`
}
...
func (x *IntArrayValue) GetArray() []*wrapperspb.Int32Value {
	if x != nil {
		return x.Array
	}
	return nil
...
type UInt64ArrayValue struct {
	...
	Array []*wrapperspb.UInt64Value `protobuf:"bytes,1,rep,name=array,proto3" json:"array,omitempty"`
}
...
func (x *UInt64ArrayValue) GetArray() []*wrapperspb.UInt64Value {
	if x != nil {
		return x.Array
	}
	return nil
