...
func (sorter *EventsChronologicalSorter) StartPipeline(ctx gocontext.Context, in <-chan *trace.TraceeEvent) (
	chan *trace.TraceeEvent, chan error) {
	out := make(chan *trace.TraceeEvent, 1000)
...
func (sorter *EventsChronologicalSorter) Start(in <-chan *trace.TraceeEvent, out chan<- *trace.TraceeEvent,
...
func (sorter *EventsChronologicalSorter) addEvent(newEvent *trace.TraceeEvent) {
...
func (sorter *EventsChronologicalSorter) sendEvents(outputChan chan<- *trace.TraceeEvent, extractionMaxTimestamp int) {
