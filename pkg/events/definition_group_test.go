...
func TestDefinitionGroup_Add(t *testing.T) {
	...
	def := NewDefinition(id, id+1000, "def", version, "", false, false, []string{}, DependencyStrategy{}, nil, nil)
...
func TestDefinitionGroup_AddBatch(t *testing.T) {
	...
	def1 := NewDefinition(id1, id1+1000, "def1", version, "", false, false, []string{}, DependencyStrategy{}, nil, nil)
	def2 := NewDefinition(id2, id2+1000, "def2", version, "", false, false, []string{}, DependencyStrategy{}, nil, nil)
...
func TestDefinitionGroup_IsASet(t *testing.T) {
	...
	def1 := NewDefinition(id1, id1+1000, "def1", version, "", false, false, []string{"set1", "set2"}, DependencyStrategy{}, nil, nil)
	def2 := NewDefinition(id2, id2+1000, "def2", version, "", false, false, []string{"set2", "set3"}, DependencyStrategy{}, nil, nil)
	def3 := NewDefinition(id3, id3+1000, "def3", version, "", false, false, []string{}, DependencyStrategy{}, nil, nil) // no sets
...
func TestDefinitionGroup_AddBatch_MultipleThreads(t *testing.T) {
	...
	for name, id := range names {
		...
		go func(name string, id ID) {
			def := NewDefinition(id, id+1000, name, version, "", false, false, []string{}, DependencyStrategy{}, nil, nil)
