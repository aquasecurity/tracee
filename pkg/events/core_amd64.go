...
const (
	...
	Rseq                ID = 334
	Uretprobe           ID = 335
	// 336 through 423 are unassigned to sync up with generic numbers
	PidfdSendSignal ID = iota + 88 // iota = 336 here 336 + 88 = 424
	IoUringSetup
	IoUringEnter
	IoUringRegister
	OpenTree
...
var SyscallSymbolNames = map[ID][]KernelRestrictions{
	...
	334: {{Name: "rseq"}},
	335: {{Below: "6.11", Name: SyscallNotImplemented}, {Above: "6.11", Name: "uretprobe"}},
