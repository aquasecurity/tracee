...
func NewDataPresentor() TypeDecoder {
...
// MoveCursor moves the buffer cursor over n bytes. This is useful to skip unwanted data.
// It returns the new cursor position. If the cursor overflows, it will not move and will return the same value.
