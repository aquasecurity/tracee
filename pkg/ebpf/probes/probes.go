...
func Init(module *bpf.Module, netEnabled bool) (Probes, error) {
	...
	allProbes := map[Handle]Probe{
		...
		TpProbeRegisterPrioMayExist: &traceProbe{eventName: "tracepoint_probe_register_prio_may_exist", probeType: kprobe, programName: "trace_tracepoint_probe_register_prio_may_exist"},
	}
