...
func NewDefaultProbeGroup(module *bpf.Module, netEnabled bool, defaultAutoload bool, binaryPath string) (*ProbeGroup, error) {
	...
	allProbes := map[Handle]Probe{
		...
		IoUringSetup:               NewTraceProbe(SyscallEnter, "io_uring_setup", "trace_io_uring_setup"),
		IoUringSetupRet:            NewTraceProbe(SyscallExit, "io_uring_setup", "trace_ret_io_uring_setup"),
