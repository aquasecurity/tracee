...
func NewDefaultProbeGroup(module *bpf.Module, netEnabled bool, defaultAutoload bool) (*ProbeGroup, error) {
	...
	allProbes := map[Handle]Probe{
		...
		NewCgroupSKBIngress:         NewCgroupProbe(bpf.BPFAttachTypeCgroupInetIngress, "new_cgroup_skb_ingress"),
		NewCgroupSKBEgress:          NewCgroupProbe(bpf.BPFAttachTypeCgroupInetEgress, "new_cgroup_skb_egress"),
