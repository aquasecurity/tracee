...
#define NO_SYSCALL        -1
    ...
    #define SYSCALL_FILE_GETATTR            468
    #define SYSCALL_FILE_SETATTR            469
    #define SYSCALL_LISTNS                  470
    #define SYSCALL_RSEQ_SLICE_YIELD        471
...
statfunc bool has_syscall_fd_arg(uint syscall_id)
{
    ...
    switch (syscall_id) {
        ...
        case SYSCALL_SETXATTRAT:
        case SYSCALL_GETXATTRAT:
        case SYSCALL_LISTXATTRAT:
        case SYSCALL_REMOVEXATTRAT:
        case SYSCALL_OPEN_TREE_ATTR:
        case SYSCALL_FILE_GETATTR:
        case SYSCALL_FILE_SETATTR:
        case SYSCALL_LISTNS:
#if !defined(bpf_target_arm64)
