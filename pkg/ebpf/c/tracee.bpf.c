...
#define MODULE_SRCVERSION_MAX_LENGTH                                                               \
    25 // srcversion is not size limited - modpost calculates srcversion with size: 25.
...
BPF_HASH(process_context_map,
         u32,
         process_context_t);                    // holds the process_context data for every tid
