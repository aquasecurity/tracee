...
func (n *nullProcessStore) GetProcess(entityId uint64) (*datastores.ProcessInfo, error) {
	return nil, datastores.ErrStoreUnhealthy
}

func (n *nullProcessStore) GetChildProcesses(entityId uint64) ([]*datastores.ProcessInfo, error) {
	return nil, datastores.ErrStoreUnhealthy
}

func (n *nullProcessStore) GetAncestry(entityId uint64, maxDepth int) ([]*datastores.ProcessInfo, error) {
	return nil, datastores.ErrStoreUnhealthy
}
