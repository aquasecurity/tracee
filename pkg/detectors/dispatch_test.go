...
func (d *producingDetector) OnEvent(ctx context.Context, event *v1beta1.Event) ([]*v1beta1.Event, error) {
	if d.outputEvent != nil {
		return []*v1beta1.Event{d.outputEvent}, nil
	}
	// Create a simple output event
	output := &v1beta1.Event{
