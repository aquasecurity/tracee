...
func TestGetDataMacro(t *testing.T) {
	...
	prog, err := CompileExpression(env, `getEventData("pathname")`)
	require.NoError(t, err, "Failed to compile getEventData macro expression")
...
func TestGetDataIntMacro(t *testing.T) {
	...
	require.NoError(t, err, "Failed to compile getEventData for int32")
...
func TestGetDataUIntMacro(t *testing.T) {
	...
	require.NoError(t, err, "Failed to compile getEventData for uint32")
...
func TestGetDataNumericComparison(t *testing.T) {
	...
	prog, err := CompileCondition(env, `getEventData("pid") > 1000`)
...
func TestGetDataBothCallForms(t *testing.T) {
	...
	prog, err := CompileExpression(env, `getEventData(event, "pathname")`)
	require.NoError(t, err, "Failed to compile getEventData binary expression")
...
func TestGetDataMacroInExpression(t *testing.T) {
	...
	prog, err := CompileExpression(env, `getEventData("pathname").startsWith("/etc")`)
...
func TestGetDataMacroInCondition(t *testing.T) {
	...
	prog, err := CompileCondition(env, `hasData("pathname") && getEventData("pathname") == "/etc/shadow"`)
...
func TestListVariableInOperator(t *testing.T) {
	...
	prog, err := CompileCondition(env, `getEventData("pathname") in SHELL_BINARIES`)
...
func TestUndefinedListVariable(t *testing.T) {
	...
	_, err = CompileCondition(env, `getEventData("pathname") in UNDEFINED_LIST`)
...
func TestListVariableComplexExpressions(t *testing.T) {
	...
	prog, err := CompileCondition(env, `getEventData("pathname") in SHELL_BINARIES || getEventData("pathname") in SENSITIVE_PATHS`)
	require.NoError(t, err, "Failed to compile complex expression")
