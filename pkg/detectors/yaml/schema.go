...
type OutputSpec struct {
	// ExtractFields defines fields to extract from input events
	ExtractFields []ExtractFieldSpec `yaml:"extract_fields,omitempty"`
}
...
type ExtractFieldSpec struct {
	...
	// Source is the extraction path (e.g., "data.pathname", "workload.process.entity_id")
