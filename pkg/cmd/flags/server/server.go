...
// The reason why we have a specific pkg for it `pkg/cmd/flags/server` is because tracee rules uses this code,
// and doesn't compile libbpfgo and isn't dependant on libbpf go, if we import 'pkf/cmd/flags' directly
// libbpfgo becomes a dependency and we need to compile it with tracee-rules.
