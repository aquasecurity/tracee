	...
	t.Run("various artifacts options", func(t *testing.T) {
		testCases := []struct {
			...
			},
			{
				...
				artifactsSlice: []string{"memory-regions.enabled"},
				expectedCapture: config.CaptureConfig{
			...
			},
			{
				...
				artifactsSlice: []string{"executable.enabled"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					Exec:       true,
				},
			},
			{
				...
				artifactsSlice: []string{"kernel-modules.enabled"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					Module:     true,
				},
			},
			{
				...
				artifactsSlice: []string{"file-write.enabled"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
			...
			},
			{
				...
				artifactsSlice: []string{"network.enabled"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
			...
			},
			{
				...
				artifactsSlice: []string{"network.enabled", "network.pcap.split=process,command,container"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					Net: config.PcapsConfig{
						CaptureSingle:    false,
			...
			},
			{
				...
				artifactsSlice: []string{"network.enabled", "network.pcap.split=command,container"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					Net: config.PcapsConfig{
						CaptureSingle:    false,
			...
			},
			{
				...
				artifactsSlice: []string{"network.enabled", "network.pcap.split=command,container", "network.pcap.snaplen=120b"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					Net: config.PcapsConfig{
						CaptureSingle:    false,
			...
			},
			{
				...
				artifactsSlice: []string{"network.enabled", "network.pcap.options=filtered"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					Net: config.PcapsConfig{
						CaptureSingle:   true,
			...
			},
			{
				...
				artifactsSlice: []string{"network.enabled", "network.pcap.options=none"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					Net: config.PcapsConfig{
						CaptureSingle:   true,
			...
			},
			{
				...
				artifactsSlice: []string{"network.enabled", "network.pcap.snaplen=max"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					Net: config.PcapsConfig{
						CaptureSingle: true,
			...
			},
			{
				...
				artifactsSlice: []string{"network.enabled", "network.pcap.snaplen=headers"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					Net: config.PcapsConfig{
						CaptureSingle: true,
			...
			},
			{
				...
				artifactsSlice: []string{"network.enabled", "network.pcap.snaplen=default"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					Net: config.PcapsConfig{
						CaptureSingle: true,
			...
			},
			{
				...
				artifactsSlice: []string{"network.enabled", "network.pcap.snaplen=1kb"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					Net: config.PcapsConfig{
						CaptureSingle: true,
			...
			},
			{
				...
				artifactsSlice: []string{"bpf-programs.enabled"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					Bpf:        true,
				},
			},
			{
				...
				artifactsSlice: []string{"file-write.enabled", "file-write.filters=path=/tmp*"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					FileWrite: config.FileCaptureConfig{
						Capture:    true,
			...
			},
			{
				...
				artifactsSlice: []string{"file-read.enabled"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
			...
			},
			{
				...
				artifactsSlice: []string{"file-read.enabled", "file-read.filters=path=/tmp*"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					FileRead: config.FileCaptureConfig{
						Capture:    true,
			...
			},
			{
				...
				artifactsSlice: []string{"file-read.enabled", "file-read.filters=type=pipe"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					FileRead: config.FileCaptureConfig{
						Capture:    true,
			...
			},
			{
				...
				artifactsSlice: []string{"file-read.enabled", "file-read.filters=fd=stdin"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					FileRead: config.FileCaptureConfig{
						Capture:    true,
			...
			},
			{
				...
				artifactsSlice: []string{"file-write.enabled", "file-write.filters=type=socket"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					FileWrite: config.FileCaptureConfig{
						Capture:    true,
			...
			},
			{
				...
				artifactsSlice: []string{"file-write.enabled", "file-write.filters=fd=stdout"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
					FileWrite: config.FileCaptureConfig{
						Capture:    true,
			...
			},
			{
				...
				artifactsSlice: []string{"file-write.enabled", "executable.enabled", "memory-regions.enabled", "kernel-modules.enabled", "bpf-programs.enabled"},
				expectedCapture: config.CaptureConfig{
					OutputPath: "/tmp/tracee/out",
			...
			},
			{
				...
				artifactsSlice: []string{"network.enabled", "network.pcap.split=invalid"},
				expectedError:  errfmt.Errorf("invalid pcap split mode: invalid"),
			},
			{
				testName:       "artifacts invalid pcap options",
				artifactsSlice: []string{"network.enabled", "network.pcap.options=invalid"},
			...
			},
			{
				...
				artifactsSlice: []string{"network.enabled", "network.pcap.snaplen=invalid"},
