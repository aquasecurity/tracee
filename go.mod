...
require (
	...
	github.com/aquasecurity/tracee/pkg/common v0.0.0
	github.com/aquasecurity/tracee/signatures/helpers v0.0.0
...
replace github.com/aquasecurity/tracee/pkg/common => ./pkg/common
