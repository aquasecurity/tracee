...
func (x *EventValue) GetValue() isEventValue_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *EventValue) GetInt32() int32 {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Int32); ok {
			return x.Int32
		}
	}
	return 0
...
func (x *EventValue) GetInt64() int64 {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Int64); ok {
			return x.Int64
		}
	}
	return 0
...
func (x *EventValue) GetUInt32() uint32 {
	if x != nil {
		if x, ok := x.Value.(*EventValue_UInt32); ok {
			return x.UInt32
		}
	}
	return 0
...
func (x *EventValue) GetUInt64() uint64 {
	if x != nil {
		if x, ok := x.Value.(*EventValue_UInt64); ok {
			return x.UInt64
		}
	}
	return 0
...
func (x *EventValue) GetStr() string {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Str); ok {
			return x.Str
		}
	}
	return ""
...
func (x *EventValue) GetBytes() []byte {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Bytes); ok {
			return x.Bytes
		}
	}
	return nil
...
func (x *EventValue) GetBool() bool {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Bool); ok {
			return x.Bool
		}
	}
	return false
...
func (x *EventValue) GetStrArray() *StringArray {
	if x != nil {
		if x, ok := x.Value.(*EventValue_StrArray); ok {
			return x.StrArray
		}
	}
	return nil
...
func (x *EventValue) GetInt32Array() *Int32Array {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Int32Array); ok {
			return x.Int32Array
		}
	}
	return nil
...
func (x *EventValue) GetUInt64Array() *UInt64Array {
	if x != nil {
		if x, ok := x.Value.(*EventValue_UInt64Array); ok {
...
func (x *EventValue) GetSockaddr() *SockAddr {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Sockaddr); ok {
			return x.Sockaddr
		}
	}
	return nil
...
func (x *EventValue) GetCredentials() *Credentials {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Credentials); ok {
...
func (x *EventValue) GetTimespec() *Timespec {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Timespec); ok {
			return x.Timespec
		}
	}
	return nil
...
func (x *EventValue) GetHookedSyscalls() *HookedSyscalls {
	if x != nil {
		if x, ok := x.Value.(*EventValue_HookedSyscalls); ok {
...
func (x *EventValue) GetHookedSeqOps() *HookedSeqOps {
	if x != nil {
		if x, ok := x.Value.(*EventValue_HookedSeqOps); ok {
...
func (x *EventValue) GetIpv4() *IPv4 {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Ipv4); ok {
			return x.Ipv4
		}
	}
	return nil
...
func (x *EventValue) GetIpv6() *IPv6 {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Ipv6); ok {
			return x.Ipv6
		}
	}
	return nil
...
func (x *EventValue) GetTcp() *TCP {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Tcp); ok {
			return x.Tcp
		}
	}
	return nil
...
func (x *EventValue) GetUdp() *UDP {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Udp); ok {
			return x.Udp
		}
	}
	return nil
...
func (x *EventValue) GetIcmp() *ICMP {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Icmp); ok {
			return x.Icmp
		}
	}
	return nil
...
func (x *EventValue) GetIcmpv6() *ICMPv6 {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Icmpv6); ok {
			return x.Icmpv6
		}
	}
	return nil
...
func (x *EventValue) GetDns() *DNS {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Dns); ok {
			return x.Dns
		}
	}
	return nil
...
func (x *EventValue) GetDnsQuestions() *DnsQuestions {
	if x != nil {
		if x, ok := x.Value.(*EventValue_DnsQuestions); ok {
...
func (x *EventValue) GetDnsResponses() *DnsResponses {
	if x != nil {
		if x, ok := x.Value.(*EventValue_DnsResponses); ok {
...
func (x *EventValue) GetPacketMetadata() *PacketMetadata {
	if x != nil {
		if x, ok := x.Value.(*EventValue_PacketMetadata); ok {
...
func (x *EventValue) GetHttp() *HTTP {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Http); ok {
			return x.Http
		}
	}
	return nil
...
func (x *EventValue) GetHttpRequest() *HTTPRequest {
	if x != nil {
		if x, ok := x.Value.(*EventValue_HttpRequest); ok {
...
func (x *EventValue) GetHttpResponse() *HTTPResponse {
	if x != nil {
		if x, ok := x.Value.(*EventValue_HttpResponse); ok {
...
func (x *EventValue) GetStruct() *structpb.Struct {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Struct); ok {
			return x.Struct
		}
	}
	return nil
...
func (x *EventValue) GetPointer() uint64 {
	if x != nil {
		if x, ok := x.Value.(*EventValue_Pointer); ok {
			return x.Pointer
		}
	}
	return 0
...
type HookedSeqOps struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	Value         map[string]*HookedSymbolData `protobuf:"bytes,1,rep,name=value,proto3" json:"value,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type HTTP struct {
	...
	Headers       map[string]*HttpHeader `protobuf:"bytes,8,rep,name=headers,proto3" json:"headers,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type HTTPRequest struct {
	...
	Host          string                 `protobuf:"bytes,4,opt,name=host,proto3" json:"host,omitempty"`
	UriPath       string                 `protobuf:"bytes,5,opt,name=uri_path,json=uriPath,proto3" json:"uri_path,omitempty"`
	Headers       map[string]*HttpHeader `protobuf:"bytes,6,rep,name=headers,proto3" json:"headers,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type HTTPResponse struct {
	...
	Protocol      string                 `protobuf:"bytes,3,opt,name=protocol,proto3" json:"protocol,omitempty"`
	Headers       map[string]*HttpHeader `protobuf:"bytes,4,rep,name=headers,proto3" json:"headers,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_api_v1beta1_event_data_proto_rawDesc = "" +
	"\n" +
	"\x1capi/v1beta1/event_data.proto\x12\x0etracee.v1beta1\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xd9\v\n" +
	"\n" +
	"EventValue\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x16\n" +
	"\x05int32\x18\x02 \x01(\x05H\x00R\x05int32\x12\x16\n" +
	"\x05int64\x18\x03 \x01(\x03H\x00R\x05int64\x12\x19\n" +
	"\au_int32\x18\x04 \x01(\rH\x00R\x06uInt32\x12\x19\n" +
	"\au_int64\x18\x05 \x01(\x04H\x00R\x06uInt64\x12\x12\n" +
	"\x03str\x18\x06 \x01(\tH\x00R\x03str\x12\x16\n" +
	"\x05bytes\x18\a \x01(\fH\x00R\x05bytes\x12\x14\n" +
	"\x04bool\x18\b \x01(\bH\x00R\x04bool\x12:\n" +
	"\tstr_array\x18\t \x01(\v2\x1b.tracee.v1beta1.StringArrayH\x00R\bstrArray\x12=\n" +
	"\vint32_array\x18\n" +
	" \x01(\v2\x1a.tracee.v1beta1.Int32ArrayH\x00R\n" +
	"int32Array\x12A\n" +
	"\ru_int64_array\x18\v \x01(\v2\x1b.tracee.v1beta1.UInt64ArrayH\x00R\vuInt64Array\x126\n" +
	"\bsockaddr\x18\f \x01(\v2\x18.tracee.v1beta1.SockAddrH\x00R\bsockaddr\x12?\n" +
	"\vcredentials\x18\r \x01(\v2\x1b.tracee.v1beta1.CredentialsH\x00R\vcredentials\x126\n" +
	"\btimespec\x18\x0e \x01(\v2\x18.tracee.v1beta1.TimespecH\x00R\btimespec\x12I\n" +
	"\x0fhooked_syscalls\x18\x0f \x01(\v2\x1e.tracee.v1beta1.HookedSyscallsH\x00R\x0ehookedSyscalls\x12D\n" +
	"\x0ehooked_seq_ops\x18\x10 \x01(\v2\x1c.tracee.v1beta1.HookedSeqOpsH\x00R\fhookedSeqOps\x12*\n" +
	"\x04ipv4\x18\x11 \x01(\v2\x14.tracee.v1beta1.IPv4H\x00R\x04ipv4\x12*\n" +
	"\x04ipv6\x18\x12 \x01(\v2\x14.tracee.v1beta1.IPv6H\x00R\x04ipv6\x12'\n" +
	"\x03tcp\x18\x13 \x01(\v2\x13.tracee.v1beta1.TCPH\x00R\x03tcp\x12'\n" +
	"\x03udp\x18\x14 \x01(\v2\x13.tracee.v1beta1.UDPH\x00R\x03udp\x12*\n" +
	"\x04icmp\x18\x15 \x01(\v2\x14.tracee.v1beta1.ICMPH\x00R\x04icmp\x120\n" +
	"\x06icmpv6\x18\x16 \x01(\v2\x16.tracee.v1beta1.ICMPv6H\x00R\x06icmpv6\x12'\n" +
	"\x03dns\x18\x17 \x01(\v2\x13.tracee.v1beta1.DNSH\x00R\x03dns\x12C\n" +
	"\rdns_questions\x18\x18 \x01(\v2\x1c.tracee.v1beta1.DnsQuestionsH\x00R\fdnsQuestions\x12C\n" +
	"\rdns_responses\x18\x19 \x01(\v2\x1c.tracee.v1beta1.DnsResponsesH\x00R\fdnsResponses\x12I\n" +
	"\x0fpacket_metadata\x18\x1a \x01(\v2\x1e.tracee.v1beta1.PacketMetadataH\x00R\x0epacketMetadata\x12*\n" +
	"\x04http\x18\x1b \x01(\v2\x14.tracee.v1beta1.HTTPH\x00R\x04http\x12@\n" +
	"\fhttp_request\x18\x1c \x01(\v2\x1b.tracee.v1beta1.HTTPRequestH\x00R\vhttpRequest\x12C\n" +
	"\rhttp_response\x18\x1d \x01(\v2\x1c.tracee.v1beta1.HTTPResponseH\x00R\fhttpResponse\x121\n" +
	"\x06struct\x18\x1e \x01(\v2\x17.google.protobuf.StructH\x00R\x06struct\x12\x1a\n" +
	"\apointer\x18\x1f \x01(\x04H\x00R\apointerB\a\n" +
	"\x05value\"#\n" +
	...
	"\vUInt64Array\x12\x14\n" +
	"\x05value\x18\x01 \x03(\x04R\x05value\"\xe4\x06\n" +
	"\vCredentials\x12.\n" +
	"\x03uid\x18\x01 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x03uid\x12.\n" +
	"\x03gid\x18\x02 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x03gid\x120\n" +
	"\x04suid\x18\x03 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x04suid\x120\n" +
	"\x04sgid\x18\x04 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x04sgid\x120\n" +
	"\x04euid\x18\x05 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x04euid\x120\n" +
	"\x04egid\x18\x06 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x04egid\x122\n" +
	"\x05fsuid\x18\a \x01(\v2\x1c.google.protobuf.UInt32ValueR\x05fsuid\x122\n" +
	"\x05fsgid\x18\b \x01(\v2\x1c.google.protobuf.UInt32ValueR\x05fsgid\x12C\n" +
	"\x0euser_namespace\x18\t \x01(\v2\x1c.google.protobuf.UInt32ValueR\ruserNamespace\x12=\n" +
	"\vsecure_bits\x18\n" +
	" \x01(\v2\x1c.google.protobuf.UInt32ValueR\n" +
	"secureBits\x12C\n" +
	"\x0fcap_inheritable\x18\v \x03(\x0e2\x1a.tracee.v1beta1.CapabilityR\x0ecapInheritable\x12?\n" +
	"\rcap_permitted\x18\f \x03(\x0e2\x1a.tracee.v1beta1.CapabilityR\fcapPermitted\x12?\n" +
	"\rcap_effective\x18\r \x03(\x0e2\x1a.tracee.v1beta1.CapabilityR\fcapEffective\x12=\n" +
	"\fcap_bounding\x18\x0e \x03(\x0e2\x1a.tracee.v1beta1.CapabilityR\vcapBounding\x12;\n" +
	"\vcap_ambient\x18\x0f \x03(\x0e2\x1a.tracee.v1beta1.CapabilityR\n" +
	"capAmbient\">\n" +
	"\bTimespec\x122\n" +
	"\x05value\x18\x01 \x01(\v2\x1c.google.protobuf.DoubleValueR\
	" \x01(\rR\aqdCount\x12\x19\n" +
	"\ban_count\x18\v \x01(\rR\aanCount\x12\x19\n" +
	"\bns_count\x18\f \x01(\rR\ansCount\x12\x19\n" +
	"\bar_count\x18\r \x01(\rR\aarCount\x129\n" +
	"\tquestions\x18\x0e \x03(\v2\x1b.tracee.v1beta1.DNSQuestionR\tquestions\x12;\n" +
	"\aanswers\x18\x0f \x03(\v2!.tracee.v1beta1.DNSResourceRecordR\aanswers\x12C\n" +
	"\vauthorities\x18\x10 \x03(\v2!.tracee.v1beta1.DNSResourceRecordR\vauthorities\x12C\n" +
	"\vadditionals\x18\x11 \x03(\v2!.tracee.v1beta1.DNSResourceRecordR\vadditionals\"K\n" +
	"\vDNSQuestion\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x14\n" +
	"\x05class\x18\x03 \x01(\tR\x05class\"\xa0\x03\n" +
	"\x11DNSResourceRecord\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x14\n" +
	"\x05class\x18\x03 \x01(\tR\x05class\x12\x10\n" +
	"\x03ttl\x18\x04 \x01(\rR\x03ttl\x12\x0e\n" +
	"\x02ip\x18\x05 \x01(\tR\x02ip\x12\x0e\n" +
	"\x02ns\x18\x06 \x01(\tR\x02ns\x12\x14\n" +
	"\x05cname\x18\a \x01(\tR\x05cname\x12\x10\n" +
	"\x03ptr\x18\b \x01(\tR\x03ptr\x12\x12\n" +
	"\x04txts\x18\t \x03(\tR\x04txts\x12(\n" +
	"\x03soa\x18\n" +
	" \x01(\v2\x16.tracee.v1beta1.DNSSOAR\x03soa\x12(\n" +
	"\x03srv\x18\v \x01(\v2\x16.tracee.v1beta1.DNSSRVR\x03srv\x12%\n" +
	"\x02mx\x18\f \x01(\v2\x15.tracee.v1beta1.DNSMXR\x02mx\x12(\n" +
	"\x03opt\x18\r \x03(\v2\x16.tracee.v1beta1.DNSOPTR\x03opt\x12(\n" +
	"\x03uri\x18\x0e \x01(\v2\x16.tracee.v1beta1.DNSURIR\x03uri\x12\x10\n" +
	"\x03txt\x18\x0f \x01(\tR\x03txt\"\xae\x01\n" +
	"\x06DNSSOA\x12\x14\n" +
	"\x05mname\x18\x01 \x01(\tR\x05mname\x12\x14\n" +
	"\x05rname\x18\x02 \x01(\tR\x05rname\x12\x16\n" +
	...
	"\x06target\x18\x03 \x01(\tR\x06target\"0\n" +
	"\x06DNSOPT\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\x12\x12\n" +
	"\x04data\x18\x02 \x01(\tR\x04data\"\xfc\x02\n" +
	"\x04HTTP\x12\x1c\n" +
	...
	"\x04host\x18\x04 \x01(\tR\x04host\x12\x19\n" +
	"\buri_path\x18\x05 \x01(\tR\auriPath\x12\x16\n" +
	"\x06status\x18\x06 \x01(\tR\x06status\x12\x1f\n" +
	"\vstatus_code\x18\a \x01(\x05R\n" +
	"statusCode\x12;\n" +
	"\aheaders\x18\b \x03(\v2!.tracee.v1beta1.HTTP.HeadersEntryR\aheaders\x12%\n" +
	"\x0econtent_length\x18\t \x01(\x03R\rcontentLength\x1aV\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x120\n" +
	"\x05value\x18\x02 \x01(\v2\x1a.tracee.v1beta1.HttpHeaderR\x05value:\x028\x01\"\xb3\x02\n" +
	"\vHTTPRequest\x12\x16\n" +
	"\x06method\x18\x01 \x01(\tR\x06method\x12\x1a\n" +
	"\bprotocol\x18\x03 \x01(\tR\bprotocol\x12\x12\n" +
	"\x04host\x18\x04 \x01(\tR\x04host\x12\x19\n" +
	"\buri_path\x18\x05 \x01(\tR\auriPath\x12B\n" +
	"\aheaders\x18\x06 \x03(\v2(.tracee.v1beta1.HTTPRequest.HeadersEntryR\aheaders\x12%\n" +
	"\x0econtent_length\x18\a \x01(\x03R\rcontentLength\x1aV\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x120\n" +
	"\x05value\x18\x02 \x01(\v2\x1a.tracee.v1beta1.HttpHeaderR\x05value:\x028\x01\"\xa7\x02\n" +
	"\fHTTPResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x1f\n" +
	"\vstatus_code\x18\x02 \x01(\x05R\n" +
	"statusCode\x12\x1a\n" +
	"\bprotocol\x18\x03 \x01(\tR\bprotocol\x12C\n" +
	"\aheaders\x18\x04 \x03(\v2).tracee.v1beta1.HTTPResponse.HeadersEntryR\aheaders\x12%\n" +
	"\x0econtent_length\x18\x05 \x01(\x03R\rcontentLength\x1aV\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x120\n" +
	"\x05value\x18\x02 \x01(\v2\x1a.tracee.v1beta1.HttpHeaderR\x05value:\x028\x01\"$\n" +
	"\n" +
	"HttpHeader\x12\x16\n" +
	"\x06header\x18\x01 \x03(\tR\x06header\"\x84\x02\n" +
	"\x0ePacketMetadata\x12\x15\n" +
	...
	"\bprotocol\x18\x05 \x01(\rR\bprotocol\x12\x1d\n" +
	"\n" +
	"packet_len\x18\x06 \x01(\rR\tpacketLen\x12\x14\n" +
	"\x05iface\x18\a \x01(\tR\x05iface\x12=\n" +
	"\tdirection\x18\b \x01(\x0e2\x1f.tracee.v1beta1.PacketDirectionR\tdirection\"d\n" +
	"\fDnsQueryData\x12\x14\n" +
	"\x05query\x18\x01 \x01(\tR\x05query\x12\x1d\n" +
	"\n" +
	"query_type\x18\x02 \x01(\tR\tqueryType\x12\x1f\n" +
	"\vquery_class\x18\x03 \x01(\tR\n" +
	"queryClass\"I\n" +
	"\tDnsAnswer\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x10\n" +
	"\x03ttl\x18\x02 \x01(\rR\x03ttl\x12\x16\n" +
	"\x06answer\x18\x03 \x01(\tR\x06answer\"\x8f\x01\n" +
	"\x0fDnsResponseData\x12B\n" +
	"\x0edns_query_data\x18\x01 \x01(\v2\x1c.tracee.v1beta1.DnsQueryDataR\fdnsQueryData\x128\n" +
	"\n" +
	"dns_answer\x18\x02 \x03(\v2\x19.tracee.v1beta1.DnsAnswerR\tdnsAnswer*M\n" +
	"\vsa_family_t\x12\x16\n" +
	"\x12SA_FAMILY_T_UNSPEC\x10\x00\x12\v\n" +
	"\aAF_UNIX\x10\x01\x12\v\n" +
	"\aAF_INET\x10\x02\x12\f\n" +
	"\bAF_INET6\x10\n" +
	"*\x85\x06\n" +
	"\n" +
	"Capability\x12\r\n" +
	"\tCAP_CHOWN\x10\x00\x12\x10\n" +
	"\fDAC_OVERRIDE\x10\x01\x12\x17\n" +
	"\x13CAP_DAC_READ_SEARCH\x10\x02\x12\x0e\n" +
	"\n" +
	"CAP_FOWNER\x10\x03\x12\x0e\n" +
	"\n" +
	"CAP_FSETID\x10\x04\x12\f\n" +
	"\bCAP_KILL\x10\x05\x12\x0e\n" +
	"\n" +
	"CAP_SETGID\x10\x06\x12\x0e\n" +
	"\n" +
	"CAP_SETUID\x10\a\x12\x0f\n" +
	"\vCAP_SETPCAP\x10\b\x12\x18\n" +
	"\x14CAP_NET_BIND_SERVICE\x10\n" +
	"\x12\x15\n" +
	"\x11CAP_NET_BROADCAST\x10\v\x12\x11\n" +
	"\rCAP_NET_ADMIN\x10\f\x12\x0f\n" +
	"\vCAP_NET_RAW\x10\r\x12\x10\n" +
	"\fCAP_IPC_LOCK\x10\x0e\x12\x11\n" +
	"\rCAP_IPC_OWNER\x10\x0f\x12\x12\n" +
	"\x0eCAP_SYS_MODULE\x10\x10\x12\x11\n" +
	"\rCAP_SYS_RAWIO\x10\x11\x12\x12\n" +
	"\x0eCAP_SYS_CHROOT\x10\x12\x12\x12\n" +
	"\x0eCAP_SYS_PTRACE\x10\x13\x12\x11\n" +
	"\rCAP_SYS_PACCT\x10\x14\x12\x11\n" +
	"\rCAP_SYS_ADMIN\x10\x15\x12\x10\n" +
	"\fCAP_SYS_BOOT\x10\x16\x12\x10\n" +
	"\fCAP_SYS_NICE\x10\x17\x12\x14\n" +
	"\x10CAP_SYS_RESOURCE\x10\x18\x12\x10\n" +
	"\fCAP_SYS_TIME\x10\x19\x12\x16\n" +
	"\x12CAP_SYS_TTY_CONFIG\x10\x1a\x12\r\n" +
	"\tCAP_MKNOD\x10\x1b\x12\r\n" +
	"\tCAP_LEASE\x10\x1c\x12\x13\n" +
	"\x0fCAP_AUDIT_WRITE\x10\x1d\x12\x15\n" +
	"\x11CAP_AUDIT_CONTROL\x10\x1e\x12\x0f\n" +
	"\vCAP_SETFCAP\x10\x1f\x12\x14\n" +
	"\x10CAP_MAC_OVERRIDE\x10 \x12\x11\n" +
	"\rCAP_MAC_ADMIN\x10!\x12\x0e\n" +
	"\n" +
	"CAP_SYSLOG\x10\"\x12\x12\n" +
	"\x0eCAP_WAKE_ALARM\x10#\x12\x15\n" +
	"\x11CAP_BLOCK_SUSPEND\x10$\x12\x12\n" +
	"\x0eCAP_AUDIT_READ\x10%\x12\x0f\n" +
	"\vCAP_PERFMON\x10&\x12\v\n" +
	"\aCAP_BPF\x10'\x12\x1a\n" +
	"\x16CAP_CHECKPOINT_RESTORE\x10(*7\n" +
	"\x0fPacketDirection\x12\v\n" +
	"\aINVALID\x10\x00\x12\v\n" +
	"\aINGRESS\x10\x01\x12\n" +
	"\n" +
	"\x06EGRESS\x10\x03B+Z)github.co/aquasecurity/tracee/api/v1beta1b\x06proto3"

var (
	file_api_v1beta1_event_data_proto_rawDescOnce sync.Once
	file_api_v1beta1_event_data_proto_rawDescData []byte
)

func file_api_v1beta1_event_data_proto_rawDescGZIP() []byte {
	file_api_v1beta1_event_data_proto_rawDescOnce.Do(func() {
		file_api_v1beta1_event_data_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_v1beta1_event_data_proto_rawDesc), len(file_api_v1beta1_event_data_proto_rawDesc)))
	})
...
func file_api_v1beta1_event_data_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_v1beta1_event_data_proto_rawDesc), len(file_api_v1beta1_event_data_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   38,
			NumExtensions: 0,
			NumServices:   0,
