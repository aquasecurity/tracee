...
func TestProcessTree_ProcessEvent(t *testing.T) {
	...
	processForkEvent := external.Event{
		...
		Args: []external.Argument{
			...
			{ArgMeta: external.ArgMeta{Name: "parent_ns_tid", Type: "int"}, Value: int32(ppid)},
			{ArgMeta: external.ArgMeta{Name: "parent_pid", Type: "int"}, Value: int32(ppid)},
			{ArgMeta: external.ArgMeta{Name: "parent_ns_pid", Type: "int"}, Value: int32(ppid)},
			{ArgMeta: external.ArgMeta{Name: "child_tid", Type: "int"}, Value: int32(pid)},
			{ArgMeta: external.ArgMeta{Name: "child_ns_tid", Type: "int"}, Value: int32(pid)},
			{ArgMeta: external.ArgMeta{Name: "child_pid", Type: "int"}, Value: int32(pid)},
			{ArgMeta: external.ArgMeta{Name: "child_ns_pid", Type: "int"}, Value: int32(pid)},
		},
	}
	...
	threadForkEvent := external.Event{
		...
		Args: []external.Argument{
			...
			{ArgMeta: external.ArgMeta{Name: "parent_ns_tid", Type: "int"}, Value: int32(pid)},
			{ArgMeta: external.ArgMeta{Name: "parent_pid", Type: "int"}, Value: int32(pid)},
			{ArgMeta: external.ArgMeta{Name: "parent_ns_pid", Type: "int"}, Value: int32(pid)},
			{ArgMeta: external.ArgMeta{Name: "child_tid", Type: "int"}, Value: int32(tid)},
			{ArgMeta: external.ArgMeta{Name: "child_ns_tid", Type: "int"}, Value: int32(tid)},
			{ArgMeta: external.ArgMeta{Name: "child_pid", Type: "int"}, Value: int32(pid)},
			{ArgMeta: external.ArgMeta{Name: "child_ns_pid", Type: "int"}, Value: int32(pid)},
		},
	}
	...
	t.Run("Ordered flows", func(t *testing.T) {
		...
		t.Run("Ordered main thread exit first", func(t *testing.T) {
			...
			var modifiedProcessExitEvent, modifiedThreadExitEvent external.Event
			modifiedProcessExitEvent = processExitEvent
			modifiedProcessExitEvent.Args = make([]external.Argument, 2)
			...
			modifiedThreadExitEvent.Args = make([]external.Argument, 2)
			...
			assert.Equal(t, timestamp(modifiedProcessExitEvent.Timestamp), process.ThreadsExits[pid])
			require.NoError(t, tree.ProcessEvent(modifiedThreadExitEvent))
			assert.Equal(t, timestamp(modifiedThreadExitEvent.Timestamp), process.ThreadsExits[tid])
			checkProcessExitSuccess(t, &tree)
		})
	})
	...
	t.Run("Missing event flow", func(t *testing.T) {
		...
		t.Run("Missing thread exit", func(t *testing.T) {
			...
			require.NoError(t, tree.ProcessEvent(processExitEvent))
			checkProcessExitInfo(t, process)
			assert.Equal(t, timestamp(processExitEvent.Timestamp), process.ThreadsExits[tid])
			checkProcessExitSuccess(t, &tree)
		})
