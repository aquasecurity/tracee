...
__rego_metadoc__ := {
    ...
    "description": "An Attempt to modify cgroup release agent file was detected. CGroups are a Linux kernel feature which allows process's resources limitations. Adversaries may use this feature for container escaping.",
    "properties": {
        "Severity": 3,
