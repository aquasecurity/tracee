...
var (
	innocentEvent = trace.TraceeEvent{
	...
	triggerCodeInjectorPtraceEvent = trace.TraceeEvent{
	...
	triggerCodeInjectorOpenEvent = trace.TraceeEvent{
	...
	triggerAntiDebuggingEvent = trace.TraceeEvent{
...
func ProduceEventsInMemory(n int) engine.EventSources {
	return ProduceEventsInMemoryRandom(n, []trace.TraceeEvent{
		innocentEvent,
		innocentEvent,
		innocentEvent,
...
func ProduceEventsInMemoryRandom(n int, seed ...trace.TraceeEvent) engine.EventSources {
	eventsCh := make(chan detect.Event, n)
