...
TRACE_RET_SYSCALL(munmap, SYS_MUNMAP,
                  ARG_TYPE0(POINTER_T)|ARG_TYPE1(SIZE_T_T),
                  ARG_TAG0(TAG_ADDR)|ARG_TAG1(TAG_LENGTH));
...
TRACE_RET_SYSCALL(sendto, SYS_SENDTO,
                  ARG_TYPE0(INT_T)|ARG_TYPE1(POINTER_T)|ARG_TYPE2(SIZE_T_T)|ARG_TYPE3(INT_T)|ARG_TYPE4(SOCKADDR_T),
                  ARG_TAG0(TAG_SOCKFD)|ARG_TAG1(TAG_BUF)|ARG_TAG2(TAG_LEN)|ARG_TAG3(TAG_FLAGS)|ARG_TAG4(TAG_DEST_ADDR));
TRACE_ENT_SYSCALL(recvfrom, SYS_RECVFROM);
TRACE_RET_SYSCALL(recvfrom, SYS_RECVFROM,
                  ARG_TYPE0(INT_T)|ARG_TYPE1(POINTER_T)|ARG_TYPE2(SIZE_T_T)|ARG_TYPE3(INT_T)|ARG_TYPE4(SOCKADDR_T),
                  ARG_TAG0(TAG_SOCKFD)|ARG_TAG1(TAG_BUF)|ARG_TAG2(TAG_LEN)|ARG_TAG3(TAG_FLAGS)|ARG_TAG4(TAG_SRC_ADDR));
...
TRACE_RET_SYSCALL(read, SYS_READ,
                  ARG_TYPE0(INT_T)|ARG_TYPE1(POINTER_T)|ARG_TYPE2(SIZE_T_T),
                  ARG_TAG0(TAG_FD)|ARG_TAG1(TAG_BUF)|ARG_TAG2(TAG_COUNT));
TRACE_ENT_SYSCALL(write, SYS_WRITE);
TRACE_RET_SYSCALL(write, SYS_WRITE,
                  ARG_TYPE0(INT_T)|ARG_TYPE1(POINTER_T)|ARG_TYPE2(SIZE_T_T),
                  ARG_TAG0(TAG_FD)|ARG_TAG1(TAG_BUF)|ARG_TAG2(TAG_COUNT));
TRACE_ENT_SYSCALL(pread64, SYS_PREAD64);
TRACE_RET_SYSCALL(pread64, SYS_PREAD64,
                  ARG_TYPE0(INT_T)|ARG_TYPE1(POINTER_T)|ARG_TYPE2(SIZE_T_T)|ARG_TYPE3(OFF_T_T),
                  ARG_TAG0(TAG_FD)|ARG_TAG1(TAG_BUF)|ARG_TAG2(TAG_COUNT)|ARG_TAG3(TAG_OFFSET));
TRACE_ENT_SYSCALL(pwrite64, SYS_PWRITE64);
TRACE_RET_SYSCALL(pwrite64, SYS_PWRITE64,
                  ARG_TYPE0(INT_T)|ARG_TYPE1(POINTER_T)|ARG_TYPE2(SIZE_T_T)|ARG_TYPE3(OFF_T_T),
                  ARG_TAG0(TAG_FD)|ARG_TAG1(TAG_BUF)|ARG_TAG2(TAG_COUNT)|ARG_TAG3(TAG_OFFSET));
TRACE_ENT_SYSCALL(lseek, SYS_LSEEK);
TRACE_RET_SYSCALL(lseek, SYS_LSEEK,
                  ARG_TYPE0(INT_T)|ARG_TYPE1(OFF_T_T)|ARG_TYPE2(INT_T),
                  ARG_TAG0(TAG_FD)|ARG_TAG1(TAG_OFFSET)|ARG_TAG2(TAG_WHENCE));
TRACE_ENT_SYSCALL(sched_yield, SYS_SCHED_YIELD);
TRACE_RET_SYSCALL(sched_yield, SYS_SCHED_YIELD, 0, 0)
TRACE_ENT_SYSCALL(msync, SYS_MSYNC);
TRACE_RET_SYSCALL(msync, SYS_MSYNC,
                  ARG_TYPE0(POINTER_T)|ARG_TYPE1(SIZE_T_T)|ARG_TYPE2(INT_T),
                  ARG_TAG0(TAG_ADDR)|ARG_TAG1(TAG_LENGTH)|ARG_TAG2(TAG_FLAGS));
TRACE_ENT_SYSCALL(madvise, SYS_MADVISE);
TRACE_RET_SYSCALL(madvise, SYS_MADVISE,
                  ARG_TYPE0(POINTER_T)|ARG_TYPE1(SIZE_T_T)|ARG_TYPE2(INT_T),
                  ARG_TAG0(TAG_ADDR)|ARG_TAG1(TAG_LENGTH)|ARG_TAG2(TAG_ADVICE));
TRACE_ENT_SYSCALL(getpid, SYS_GETPID);
TRACE_RET_SYSCALL(getpid, SYS_GETPID, 0, 0)
TRACE_ENT_SYSCALL(getppid, SYS_GETPPID);
TRACE_RET_SYSCALL(getppid, SYS_GETPPID, 0, 0)
TRACE_ENT_SYSCALL(gettid, SYS_GETTID);
TRACE_RET_SYSCALL(gettid, SYS_GETTID, 0, 0)
