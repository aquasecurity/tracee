...
var EventsIDToEvent = map[int32]EventConfig{
	...
	PollEventID:                EventConfig{ID: PollEventID, ID32Bit: sys32poll, Name: "poll", Probes: []probe{probe{event: "poll", attach: sysCall, fn: "poll"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_mux_io"}},
	...
	RtSigactionEventID:         EventConfig{ID: RtSigactionEventID, ID32Bit: sys32rt_sigaction, Name: "rt_sigaction", Probes: []probe{probe{event: "rt_sigaction", attach: sysCall, fn: "rt_sigaction"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	RtSigprocmaskEventID:       EventConfig{ID: RtSigprocmaskEventID, ID32Bit: sys32rt_sigprocmask, Name: "rt_sigprocmask", Probes: []probe{probe{event: "rt_sigprocmask", attach: sysCall, fn: "rt_sigprocmask"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	RtSigreturnEventID:         EventConfig{ID: RtSigreturnEventID, ID32Bit: sys32rt_sigreturn, Name: "rt_sigreturn", Probes: []probe{probe{event: "rt_sigreturn", attach: sysCall, fn: "rt_sigreturn"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	...
	ReadvEventID:               EventConfig{ID: ReadvEventID, ID32Bit: sys32readv, Name: "readv", Probes: []probe{probe{event: "readv", attach: sysCall, fn: "readv"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_read_write"}},
	WritevEventID:              EventConfig{ID: WritevEventID, ID32Bit: sys32writev, Name: "writev", Probes: []probe{probe{event: "writev", attach: sysCall, fn: "writev"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_read_write"}},
	...
	PipeEventID:                EventConfig{ID: PipeEventID, ID32Bit: sys32pipe, Name: "pipe", Probes: []probe{probe{event: "pipe", attach: sysCall, fn: "pipe"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_pipe"}},
	SelectEventID:              EventConfig{ID: SelectEventID, ID32Bit: sys32select, Name: "select", Probes: []probe{probe{event: "select", attach: sysCall, fn: "select"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_mux_io"}},
	...
	MremapEventID:              EventConfig{ID: MremapEventID, ID32Bit: sys32mremap, Name: "mremap", Probes: []probe{probe{event: "mremap", attach: sysCall, fn: "mremap"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_mem"}},
	...
	MincoreEventID:             EventConfig{ID: MincoreEventID, ID32Bit: sys32mincore, Name: "mincore", Probes: []probe{probe{event: "mincore", attach: sysCall, fn: "mincore"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_mem"}},
	...
	ShmgetEventID:              EventConfig{ID: ShmgetEventID, ID32Bit: sys32shmget, Name: "shmget", Probes: []probe{probe{event: "shmget", attach: sysCall, fn: "shmget"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_shm"}},
	ShmatEventID:               EventConfig{ID: ShmatEventID, ID32Bit: sys32shmat, Name: "shmat", Probes: []probe{probe{event: "shmat", attach: sysCall, fn: "shmat"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_shm"}},
	ShmctlEventID:              EventConfig{ID: ShmctlEventID, ID32Bit: sys32shmctl, Name: "shmctl", Probes: []probe{probe{event: "shmctl", attach: sysCall, fn: "shmctl"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_shm"}},
	...
	PauseEventID:               EventConfig{ID: PauseEventID, ID32Bit: sys32pause, Name: "pause", Probes: []probe{probe{event: "pause", attach: sysCall, fn: "pause"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	NanosleepEventID:           EventConfig{ID: NanosleepEventID, ID32Bit: sys32nanosleep, Name: "nanosleep", Probes: []probe{probe{event: "nanosleep", attach: sysCall, fn: "nanosleep"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_timer"}},
	GetitimerEventID:           EventConfig{ID: GetitimerEventID, ID32Bit: sys32getitimer, Name: "getitimer", Probes: []probe{probe{event: "getitimer", attach: sysCall, fn: "getitimer"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_timer"}},
	AlarmEventID:               EventConfig{ID: AlarmEventID, ID32Bit: sys32alarm, Name: "alarm", Probes: []probe{probe{event: "alarm", attach: sysCall, fn: "alarm"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_timer"}},
	SetitimerEventID:           EventConfig{ID: SetitimerEventID, ID32Bit: sys32setitimer, Name: "setitimer", Probes: []probe{probe{event: "setitimer", attach: sysCall, fn: "setitimer"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_timer"}},
	...
	SendfileEventID:            EventConfig{ID: SendfileEventID, ID32Bit: sys32sendfile, Name: "sendfile", Probes: []probe{probe{event: "sendfile", attach: sysCall, fn: "sendfile"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_read_write"}},
	...
	SendmsgEventID:             EventConfig{ID: SendmsgEventID, ID32Bit: sys32sendmsg, Name: "sendmsg", Probes: []probe{probe{event: "sendmsg", attach: sysCall, fn: "sendmsg"}}, EssentialEvent: false, Sets: []string{"syscalls", "net", "net_snd_rcv"}},
	RecvmsgEventID:             EventConfig{ID: RecvmsgEventID, ID32Bit: sys32recvmsg, Name: "recvmsg", Probes: []probe{probe{event: "recvmsg", attach: sysCall, fn: "recvmsg"}}, EssentialEvent: false, Sets: []string{"syscalls", "net", "net_snd_rcv"}},
	ShutdownEventID:            EventConfig{ID: ShutdownEventID, ID32Bit: sys32shutdown, Name: "shutdown", Probes: []probe{probe{event: "shutdown", attach: sysCall, fn: "shutdown"}}, EssentialEvent: false, Sets: []string{"syscalls", "net", "net_sock"}},
	...
	GetpeernameEventID:         EventConfig{ID: GetpeernameEventID, ID32Bit: sys32getpeername, Name: "getpeername", Probes: []probe{probe{event: "getpeername", attach: sysCall, fn: "getpeername"}}, EssentialEvent: false, Sets: []string{"syscalls", "net", "net_sock"}},
	SocketpairEventID:          EventConfig{ID: SocketpairEventID, ID32Bit: sys32socketpair, Name: "socketpair", Probes: []probe{probe{event: "socketpair", attach: sysCall, fn: "socketpair"}}, EssentialEvent: false, Sets: []string{"syscalls", "net", "net_sock"}},
	SetsockoptEventID:          EventConfig{ID: SetsockoptEventID, ID32Bit: sys32setsockopt, Name: "setsockopt", Probes: []probe{probe{event: "setsockopt", attach: sysCall, fn: "setsockopt"}}, EssentialEvent: false, Sets: []string{"syscalls", "net", "net_sock"}},
	GetsockoptEventID:          EventConfig{ID: GetsockoptEventID, ID32Bit: sys32getsockopt, Name: "getsockopt", Probes: []probe{probe{event: "getsockopt", attach: sysCall, fn: "getsockopt"}}, EssentialEvent: false, Sets: []string{"syscalls", "net", "net_sock"}},
	...
	ExitEventID:                EventConfig{ID: ExitEventID, ID32Bit: sys32exit, Name: "exit", Probes: []probe{probe{event: "exit", attach: sysCall, fn: "exit"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_life"}},
	Wait4EventID:               EventConfig{ID: Wait4EventID, ID32Bit: sys32wait4, Name: "wait4", Probes: []probe{probe{event: "wait4", attach: sysCall, fn: "wait4"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_life"}},
	...
	UnameEventID:               EventConfig{ID: UnameEventID, ID32Bit: sys32uname, Name: "uname", Probes: []probe{probe{event: "uname", attach: sysCall, fn: "uname"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	SemgetEventID:              EventConfig{ID: SemgetEventID, ID32Bit: sys32semget, Name: "semget", Probes: []probe{probe{event: "semget", attach: sysCall, fn: "semget"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_sem"}},
	SemopEventID:               EventConfig{ID: SemopEventID, ID32Bit: sys32undefined, Name: "semop", Probes: []probe{probe{event: "semop", attach: sysCall, fn: "semop"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_sem"}},
	SemctlEventID:              EventConfig{ID: SemctlEventID, ID32Bit: sys32semctl, Name: "semctl", Probes: []probe{probe{event: "semctl", attach: sysCall, fn: "semctl"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_sem"}},
	ShmdtEventID:               EventConfig{ID: ShmdtEventID, ID32Bit: sys32shmdt, Name: "shmdt", Probes: []probe{probe{event: "shmdt", attach: sysCall, fn: "shmdt"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_shm"}},
	MsggetEventID:              EventConfig{ID: MsggetEventID, ID32Bit: sys32msgget, Name: "msgget", Probes: []probe{probe{event: "msgget", attach: sysCall, fn: "msgget"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_msgq"}},
	MsgsndEventID:              EventConfig{ID: MsgsndEventID, ID32Bit: sys32msgsnd, Name: "msgsnd", Probes: []probe{probe{event: "msgsnd", attach: sysCall, fn: "msgsnd"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_msgq"}},
	MsgrcvEventID:              EventConfig{ID: MsgrcvEventID, ID32Bit: sys32msgrcv, Name: "msgrcv", Probes: []probe{probe{event: "msgrcv", attach: sysCall, fn: "msgrcv"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_msgq"}},
	MsgctlEventID:              EventConfig{ID: MsgctlEventID, ID32Bit: sys32msgctl, Name: "msgctl", Probes: []probe{probe{event: "msgctl", attach: sysCall, fn: "msgctl"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_msgq"}},
	FcntlEventID:               EventConfig{ID: FcntlEventID, ID32Bit: sys32fcntl, Name: "fcntl", Probes: []probe{probe{event: "fcntl", attach: sysCall, fn: "fcntl"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_fd_ops"}},
	FlockEventID:               EventConfig{ID: FlockEventID, ID32Bit: sys32flock, Name: "flock", Probes: []probe{probe{event: "flock", attach: sysCall, fn: "flock"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_fd_ops"}},
	FsyncEventID:               EventConfig{ID: FsyncEventID, ID32Bit: sys32fsync, Name: "fsync", Probes: []probe{probe{event: "fsync", attach: sysCall, fn: "fsync"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_sync"}},
	FdatasyncEventID:           EventConfig{ID: FdatasyncEventID, ID32Bit: sys32fdatasync, Name: "fdatasync", Probes: []probe{probe{event: "fdatasync", attach: sysCall, fn: "fdatasync"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_sync"}},
	TruncateEventID:            EventConfig{ID: TruncateEventID, ID32Bit: sys32truncate, Name: "truncate", Probes: []probe{probe{event: "truncate", attach: sysCall, fn: "truncate"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_ops"}},
	FtruncateEventID:           EventConfig{ID: FtruncateEventID, ID32Bit: sys32ftruncate, Name: "ftruncate", Probes: []probe{probe{event: "ftruncate", attach: sysCall, fn: "ftruncate"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_ops"}},
	...
	GetcwdEventID:              EventConfig{ID: GetcwdEventID, ID32Bit: sys32getcwd, Name: "getcwd", Probes: []probe{probe{event: "getcwd", attach: sysCall, fn: "getcwd"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_dir_ops"}},
	ChdirEventID:               EventConfig{ID: ChdirEventID, ID32Bit: sys32chdir, Name: "chdir", Probes: []probe{probe{event: "chdir", attach: sysCall, fn: "chdir"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_dir_ops"}},
	FchdirEventID:              EventConfig{ID: FchdirEventID, ID32Bit: sys32fchdir, Name: "fchdir", Probes: []probe{probe{event: "fchdir", attach: sysCall, fn: "fchdir"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_dir_ops"}},
	RenameEventID:              EventConfig{ID: RenameEventID, ID32Bit: sys32rename, Name: "rename", Probes: []probe{probe{event: "rename", attach: sysCall, fn: "rename"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_ops"}},
	MkdirEventID:               EventConfig{ID: MkdirEventID, ID32Bit: sys32mkdir, Name: "mkdir", Probes: []probe{probe{event: "mkdir", attach: sysCall, fn: "mkdir"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_dir_ops"}},
	RmdirEventID:               EventConfig{ID: RmdirEventID, ID32Bit: sys32rmdir, Name: "rmdir", Probes: []probe{probe{event: "rmdir", attach: sysCall, fn: "rmdir"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_dir_ops"}},
	...
	LinkEventID:                EventConfig{ID: LinkEventID, ID32Bit: sys32link, Name: "link", Probes: []probe{probe{event: "link", attach: sysCall, fn: "link"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_link_ops"}},
	...
	ReadlinkEventID:            EventConfig{ID: ReadlinkEventID, ID32Bit: sys32readlink, Name: "readlink", Probes: []probe{probe{event: "readlink", attach: sysCall, fn: "readlink"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_link_ops"}},
	...
	UmaskEventID:               EventConfig{ID: UmaskEventID, ID32Bit: sys32umask, Name: "umask", Probes: []probe{probe{event: "umask", attach: sysCall, fn: "umask"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	GettimeofdayEventID:        EventConfig{ID: GettimeofdayEventID, ID32Bit: sys32gettimeofday, Name: "gettimeofday", Probes: []probe{probe{event: "gettimeofday", attach: sysCall, fn: "gettimeofday"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_tod"}},
	GetrlimitEventID:           EventConfig{ID: GetrlimitEventID, ID32Bit: sys32getrlimit, Name: "getrlimit", Probes: []probe{probe{event: "getrlimit", attach: sysCall, fn: "getrlimit"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	GetrusageEventID:           EventConfig{ID: GetrusageEventID, ID32Bit: sys32getrusage, Name: "getrusage", Probes: []probe{probe{event: "getrusage", attach: sysCall, fn: "getrusage"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	SysinfoEventID:             EventConfig{ID: SysinfoEventID, ID32Bit: sys32sysinfo, Name: "sysinfo", Probes: []probe{probe{event: "sysinfo", attach: sysCall, fn: "sysinfo"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	TimesEventID:               EventConfig{ID: TimesEventID, ID32Bit: sys32times, Name: "times", Probes: []probe{probe{event: "times", attach: sysCall, fn: "times"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	...
	GetuidEventID:              EventConfig{ID: GetuidEventID, ID32Bit: sys32getuid, Name: "getuid", Probes: []probe{probe{event: "getuid", attach: sysCall, fn: "getuid"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_ids"}},
	SyslogEventID:              EventConfig{ID: SyslogEventID, ID32Bit: sys32syslog, Name: "syslog", Probes: []probe{probe{event: "syslog", attach: sysCall, fn: "syslog"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	GetgidEventID:              EventConfig{ID: GetgidEventID, ID32Bit: sys32getgid, Name: "getgid", Probes: []probe{probe{event: "getgid", attach: sysCall, fn: "getgid"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_ids"}},
	...
	GeteuidEventID:             EventConfig{ID: GeteuidEventID, ID32Bit: sys32geteuid, Name: "geteuid", Probes: []probe{probe{event: "geteuid", attach: sysCall, fn: "geteuid"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_ids"}},
	GetegidEventID:             EventConfig{ID: GetegidEventID, ID32Bit: sys32getegid, Name: "getegid", Probes: []probe{probe{event: "getegid", attach: sysCall, fn: "getegid"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_ids"}},
	SetpgidEventID:             EventConfig{ID: SetpgidEventID, ID32Bit: sys32setpgid, Name: "setpgid", Probes: []probe{probe{event: "setpgid", attach: sysCall, fn: "setpgid"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_ids"}},
	...
	GetpgrpEventID:             EventConfig{ID: GetpgrpEventID, ID32Bit: sys32getpgrp, Name: "getpgrp", Probes: []probe{probe{event: "getpgrp", attach: sysCall, fn: "getpgrp"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_ids"}},
	SetsidEventID:              EventConfig{ID: SetsidEventID, ID32Bit: sys32setsid, Name: "setsid", Probes: []probe{probe{event: "setsid", attach: sysCall, fn: "setsid"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_ids"}},
	...
	GetgroupsEventID:           EventConfig{ID: GetgroupsEventID, ID32Bit: sys32getgroups, Name: "getgroups", Probes: []probe{probe{event: "getgroups", attach: sysCall, fn: "getgroups"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_ids"}},
	SetgroupsEventID:           EventConfig{ID: SetgroupsEventID, ID32Bit: sys32setgroups, Name: "setgroups", Probes: []probe{probe{event: "setgroups", attach: sysCall, fn: "setgroups"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_ids"}},
	SetresuidEventID:           EventConfig{ID: SetresuidEventID, ID32Bit: sys32setresuid, Name: "setresuid", Probes: []probe{probe{event: "setresuid", attach: sysCall, fn: "setresuid"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_ids"}},
	GetresuidEventID:           EventConfig{ID: GetresuidEventID, ID32Bit: sys32getresuid, Name: "getresuid", Probes: []probe{probe{event: "getresuid", attach: sysCall, fn: "getresuid"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_ids"}},
	SetresgidEventID:           EventConfig{ID: SetresgidEventID, ID32Bit: sys32setresgid, Name: "setresgid", Probes: []probe{probe{event: "setresgid", attach: sysCall, fn: "setresgid"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_ids"}},
	GetresgidEventID:           EventConfig{ID: GetresgidEventID, ID32Bit: sys32getresgid, Name: "getresgid", Probes: []probe{probe{event: "getresgid", attach: sysCall, fn: "getresgid"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_ids"}},
	GetpgidEventID:             EventConfig{ID: GetpgidEventID, ID32Bit: sys32getpgid, Name: "getpgid", Probes: []probe{probe{event: "getpgid", attach: sysCall, fn: "getpgid"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_ids"}},
	...
	GetsidEventID:              EventConfig{ID: GetsidEventID, ID32Bit: sys32getsid, Name: "getsid", Probes: []probe{probe{event: "getsid", attach: sysCall, fn: "getsid"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_ids"}},
	CapgetEventID:              EventConfig{ID: CapgetEventID, ID32Bit: sys32capget, Name: "capget", Probes: []probe{probe{event: "capget", attach: sysCall, fn: "capget"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	CapsetEventID:              EventConfig{ID: CapsetEventID, ID32Bit: sys32capset, Name: "capset", Probes: []probe{probe{event: "capset", attach: sysCall, fn: "capset"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	RtSigpendingEventID:        EventConfig{ID: RtSigpendingEventID, ID32Bit: sys32rt_sigpending, Name: "rt_sigpending", Probes: []probe{probe{event: "rt_sigpending", attach: sysCall, fn: "rt_sigpending"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	RtSigtimedwaitEventID:      EventConfig{ID: RtSigtimedwaitEventID, ID32Bit: sys32rt_sigtimedwait, Name: "rt_sigtimedwait", Probes: []probe{probe{event: "rt_sigtimedwait", attach: sysCall, fn: "rt_sigtimedwait"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	RtSigqueueinfoEventID:      EventConfig{ID: RtSigqueueinfoEventID, ID32Bit: sys32rt_sigqueueinfo, Name: "rt_sigqueueinfo", Probes: []probe{probe{event: "rt_sigqueueinfo", attach: sysCall, fn: "rt_sigqueueinfo"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	RtSigsuspendEventID:        EventConfig{ID: RtSigsuspendEventID, ID32Bit: sys32rt_sigsuspend, Name: "rt_sigsuspend", Probes: []probe{probe{event: "rt_sigsuspend", attach: sysCall, fn: "rt_sigsuspend"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	SigaltstackEventID:         EventConfig{ID: SigaltstackEventID, ID32Bit: sys32sigaltstack, Name: "sigaltstack", Probes: []probe{probe{event: "sigaltstack", attach: sysCall, fn: "sigaltstack"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	UtimeEventID:               EventConfig{ID: UtimeEventID, ID32Bit: sys32utime, Name: "utime", Probes: []probe{probe{event: "utime", attach: sysCall, fn: "utime"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	...
	UselibEventID:              EventConfig{ID: UselibEventID, ID32Bit: sys32uselib, Name: "uselib", Probes: []probe{probe{event: "uselib", attach: sysCall, fn: "uselib"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	PersonalityEventID:         EventConfig{ID: PersonalityEventID, ID32Bit: sys32personality, Name: "personality", Probes: []probe{probe{event: "personality", attach: sysCall, fn: "personality"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	UstatEventID:               EventConfig{ID: UstatEventID, ID32Bit: sys32ustat, Name: "ustat", Probes: []probe{probe{event: "ustat", attach: sysCall, fn: "ustat"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_info"}},
	StatfsEventID:              EventConfig{ID: StatfsEventID, ID32Bit: sys32statfs, Name: "statfs", Probes: []probe{probe{event: "statfs", attach: sysCall, fn: "statfs"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_info"}},
	FstatfsEventID:             EventConfig{ID: FstatfsEventID, ID32Bit: sys32fstatfs, Name: "fstatfs", Probes: []probe{probe{event: "fstatfs", attach: sysCall, fn: "fstatfs"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_info"}},
	SysfsEventID:               EventConfig{ID: SysfsEventID, ID32Bit: sys32sysfs, Name: "sysfs", Probes: []probe{probe{event: "sysfs", attach: sysCall, fn: "sysfs"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_info"}},
	GetpriorityEventID:         EventConfig{ID: GetpriorityEventID, ID32Bit: sys32getpriority, Name: "getpriority", Probes: []probe{probe{event: "getpriority", attach: sysCall, fn: "getpriority"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_sched"}},
	SetpriorityEventID:         EventConfig{ID: SetpriorityEventID, ID32Bit: sys32setpriority, Name: "setpriority", Probes: []probe{probe{event: "setpriority", attach: sysCall, fn: "setpriority"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_sched"}},
	SchedSetparamEventID:       EventConfig{ID: SchedSetparamEventID, ID32Bit: sys32sched_setparam, Name: "sched_setparam", Probes: []probe{probe{event: "sched_setparam", attach: sysCall, fn: "sched_setparam"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_sched"}},
	SchedGetparamEventID:       EventConfig{ID: SchedGetparamEventID, ID32Bit: sys32sched_getparam, Name: "sched_getparam", Probes: []probe{probe{event: "sched_getparam", attach: sysCall, fn: "sched_getparam"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_sched"}},
	SchedSetschedulerEventID:   EventConfig{ID: SchedSetschedulerEventID, ID32Bit: sys32sched_setscheduler, Name: "sched_setscheduler", Probes: []probe{probe{event: "sched_setscheduler", attach: sysCall, fn: "sched_setscheduler"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_sched"}},
	SchedGetschedulerEventID:   EventConfig{ID: SchedGetschedulerEventID, ID32Bit: sys32sched_getscheduler, Name: "sched_getscheduler", Probes: []probe{probe{event: "sched_getscheduler", attach: sysCall, fn: "sched_getscheduler"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_sched"}},
	SchedGetPriorityMaxEventID: EventConfig{ID: SchedGetPriorityMaxEventID, ID32Bit: sys32sched_get_priority_max, Name: "sched_get_priority_max", Probes: []probe{probe{event: "sched_get_priority_max", attach: sysCall, fn: "sched_get_priority_max"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_sched"}},
	SchedGetPriorityMinEventID: EventConfig{ID: SchedGetPriorityMinEventID, ID32Bit: sys32sched_get_priority_min, Name: "sched_get_priority_min", Probes: []probe{probe{event: "sched_get_priority_min", attach: sysCall, fn: "sched_get_priority_min"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_sched"}},
	SchedRrGetIntervalEventID:  EventConfig{ID: SchedRrGetIntervalEventID, ID32Bit: sys32sched_rr_get_interval, Name: "sched_rr_get_interval", Probes: []probe{probe{event: "sched_rr_get_interval", attach: sysCall, fn: "sched_rr_get_interval"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_sched"}},
	MlockEventID:               EventConfig{ID: MlockEventID, ID32Bit: sys32mlock, Name: "mlock", Probes: []probe{probe{event: "mlock", attach: sysCall, fn: "mlock"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_mem"}},
	MunlockEventID:             EventConfig{ID: MunlockEventID, ID32Bit: sys32munlock, Name: "munlock", Probes: []probe{probe{event: "munlock", attach: sysCall, fn: "munlock"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_mem"}},
	MlockallEventID:            EventConfig{ID: MlockallEventID, ID32Bit: sys32mlockall, Name: "mlockall", Probes: []probe{probe{event: "mlockall", attach: sysCall, fn: "mlockall"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_mem"}},
	MunlockallEventID:          EventConfig{ID: MunlockallEventID, ID32Bit: sys32munlockall, Name: "munlockall", Probes: []probe{probe{event: "munlockall", attach: sysCall, fn: "munlockall"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_mem"}},
	VhangupEventID:             EventConfig{ID: VhangupEventID, ID32Bit: sys32vhangup, Name: "vhangup", Probes: []probe{probe{event: "vhangup", attach: sysCall, fn: "vhangup"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	ModifyLdtEventID:           EventConfig{ID: ModifyLdtEventID, ID32Bit: sys32modify_ldt, Name: "modify_ldt", Probes: []probe{probe{event: "modify_ldt", attach: sysCall, fn: "modify_ldt"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_mem"}},
	PivotRootEventID:           EventConfig{ID: PivotRootEventID, ID32Bit: sys32pivot_root, Name: "pivot_root", Probes: []probe{probe{event: "pivot_root", attach: sysCall, fn: "pivot_root"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs"}},
	SysctlEventID:              EventConfig{ID: SysctlEventID, ID32Bit: sys32undefined, Name: "sysctl", Probes: []probe{probe{event: "sysctl", attach: sysCall, fn: "sysctl"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	...
	ArchPrctlEventID:           EventConfig{ID: ArchPrctlEventID, ID32Bit: sys32arch_prctl, Name: "arch_prctl", Probes: []probe{probe{event: "arch_prctl", attach: sysCall, fn: "arch_prctl"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	AdjtimexEventID:            EventConfig{ID: AdjtimexEventID, ID32Bit: sys32adjtimex, Name: "adjtimex", Probes: []probe{probe{event: "adjtimex", attach: sysCall, fn: "adjtimex"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_clock"}},
	SetrlimitEventID:           EventConfig{ID: SetrlimitEventID, ID32Bit: sys32setrlimit, Name: "setrlimit", Probes: []probe{probe{event: "setrlimit", attach: sysCall, fn: "setrlimit"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	ChrootEventID:              EventConfig{ID: ChrootEventID, ID32Bit: sys32chroot, Name: "chroot", Probes: []probe{probe{event: "chroot", attach: sysCall, fn: "chroot"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_dir_ops"}},
	SyncEventID:                EventConfig{ID: SyncEventID, ID32Bit: sys32sync, Name: "sync", Probes: []probe{probe{event: "sync", attach: sysCall, fn: "sync"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_sync"}},
	AcctEventID:                EventConfig{ID: AcctEventID, ID32Bit: sys32acct, Name: "acct", Probes: []probe{probe{event: "acct", attach: sysCall, fn: "acct"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	SettimeofdayEventID:        EventConfig{ID: SettimeofdayEventID, ID32Bit: sys32settimeofday, Name: "settimeofday", Probes: []probe{probe{event: "settimeofday", attach: sysCall, fn: "settimeofday"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_tod"}},
	...
	SwaponEventID:              EventConfig{ID: SwaponEventID, ID32Bit: sys32swapon, Name: "swapon", Probes: []probe{probe{event: "swapon", attach: sysCall, fn: "swapon"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs"}},
	SwapoffEventID:             EventConfig{ID: SwapoffEventID, ID32Bit: sys32swapoff, Name: "swapoff", Probes: []probe{probe{event: "swapoff", attach: sysCall, fn: "swapoff"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs"}},
	RebootEventID:              EventConfig{ID: RebootEventID, ID32Bit: sys32reboot, Name: "reboot", Probes: []probe{probe{event: "reboot", attach: sysCall, fn: "reboot"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	SethostnameEventID:         EventConfig{ID: SethostnameEventID, ID32Bit: sys32sethostname, Name: "sethostname", Probes: []probe{probe{event: "sethostname", attach: sysCall, fn: "sethostname"}}, EssentialEvent: false, Sets: []string{"syscalls", "net"}},
	SetdomainnameEventID:       EventConfig{ID: SetdomainnameEventID, ID32Bit: sys32setdomainname, Name: "setdomainname", Probes: []probe{probe{event: "setdomainname", attach: sysCall, fn: "setdomainname"}}, EssentialEvent: false, Sets: []string{"syscalls", "net"}},
	IoplEventID:                EventConfig{ID: IoplEventID, ID32Bit: sys32iopl, Name: "iopl", Probes: []probe{probe{event: "iopl", attach: sysCall, fn: "iopl"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	IopermEventID:              EventConfig{ID: IopermEventID, ID32Bit: sys32ioperm, Name: "ioperm", Probes: []probe{probe{event: "ioperm", attach: sysCall, fn: "ioperm"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	CreateModuleEventID:        EventConfig{ID: CreateModuleEventID, ID32Bit: sys32create_module, Name: "create_module", Probes: []probe{probe{event: "create_module", attach: sysCall, fn: "create_module"}}, EssentialEvent: false, Sets: []string{"syscalls", "system", "system_module"}},
	...
	GetKernelSymsEventID:       EventConfig{ID: GetKernelSymsEventID, ID32Bit: sys32get_kernel_syms, Name: "get_kernel_syms", Probes: []probe{probe{event: "get_kernel_syms", attach: sysCall, fn: "get_kernel_syms"}}, EssentialEvent: false, Sets: []string{"syscalls", "system", "system_module"}},
	QueryModuleEventID:         EventConfig{ID: QueryModuleEventID, ID32Bit: sys32query_module, Name: "query_module", Probes: []probe{probe{event: "query_module", attach: sysCall, fn: "query_module"}}, EssentialEvent: false, Sets: []string{"syscalls", "system", "system_module"}},
	QuotactlEventID:            EventConfig{ID: QuotactlEventID, ID32Bit: sys32quotactl, Name: "quotactl", Probes: []probe{probe{event: "quotactl", attach: sysCall, fn: "quotactl"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	NfsservctlEventID:          EventConfig{ID: NfsservctlEventID, ID32Bit: sys32nfsservctl, Name: "nfsservctl", Probes: []probe{probe{event: "nfsservctl", attach: sysCall, fn: "nfsservctl"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs"}},
	GetpmsgEventID:             EventConfig{ID: GetpmsgEventID, ID32Bit: sys32getpmsg, Name: "getpmsg", Probes: []probe{probe{event: "getpmsg", attach: sysCall, fn: "getpmsg"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	PutpmsgEventID:             EventConfig{ID: PutpmsgEventID, ID32Bit: sys32putpmsg, Name: "putpmsg", Probes: []probe{probe{event: "putpmsg", attach: sysCall, fn: "putpmsg"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	AfsEventID:                 EventConfig{ID: AfsEventID, ID32Bit: sys32undefined, Name: "afs", Probes: []probe{probe{event: "afs", attach: sysCall, fn: "afs"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	TuxcallEventID:             EventConfig{ID: TuxcallEventID, ID32Bit: sys32undefined, Name: "tuxcall", Probes: []probe{probe{event: "tuxcall", attach: sysCall, fn: "tuxcall"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	SecurityEventID:            EventConfig{ID: SecurityEventID, ID32Bit: sys32undefined, Name: "security", Probes: []probe{probe{event: "security", attach: sysCall, fn: "security"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	...
	ReadaheadEventID:           EventConfig{ID: ReadaheadEventID, ID32Bit: sys32readahead, Name: "readahead", Probes: []probe{probe{event: "readahead", attach: sysCall, fn: "readahead"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs"}},
	SetxattrEventID:            EventConfig{ID: SetxattrEventID, ID32Bit: sys32setxattr, Name: "setxattr", Probes: []probe{probe{event: "setxattr", attach: sysCall, fn: "setxattr"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	LsetxattrEventID:           EventConfig{ID: LsetxattrEventID, ID32Bit: sys32lsetxattr, Name: "lsetxattr", Probes: []probe{probe{event: "lsetxattr", attach: sysCall, fn: "lsetxattr"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	FsetxattrEventID:           EventConfig{ID: FsetxattrEventID, ID32Bit: sys32fsetxattr, Name: "fsetxattr", Probes: []probe{probe{event: "fsetxattr", attach: sysCall, fn: "fsetxattr"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	GetxattrEventID:            EventConfig{ID: GetxattrEventID, ID32Bit: sys32getxattr, Name: "getxattr", Probes: []probe{probe{event: "getxattr", attach: sysCall, fn: "getxattr"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	LgetxattrEventID:           EventConfig{ID: LgetxattrEventID, ID32Bit: sys32lgetxattr, Name: "lgetxattr", Probes: []probe{probe{event: "lgetxattr", attach: sysCall, fn: "lgetxattr"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	FgetxattrEventID:           EventConfig{ID: FgetxattrEventID, ID32Bit: sys32fgetxattr, Name: "fgetxattr", Probes: []probe{probe{event: "fgetxattr", attach: sysCall, fn: "fgetxattr"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	ListxattrEventID:           EventConfig{ID: ListxattrEventID, ID32Bit: sys32listxattr, Name: "listxattr", Probes: []probe{probe{event: "listxattr", attach: sysCall, fn: "listxattr"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	LlistxattrEventID:          EventConfig{ID: LlistxattrEventID, ID32Bit: sys32llistxattr, Name: "llistxattr", Probes: []probe{probe{event: "llistxattr", attach: sysCall, fn: "llistxattr"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	FlistxattrEventID:          EventConfig{ID: FlistxattrEventID, ID32Bit: sys32flistxattr, Name: "flistxattr", Probes: []probe{probe{event: "flistxattr", attach: sysCall, fn: "flistxattr"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	RemovexattrEventID:         EventConfig{ID: RemovexattrEventID, ID32Bit: sys32removexattr, Name: "removexattr", Probes: []probe{probe{event: "removexattr", attach: sysCall, fn: "removexattr"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	LremovexattrEventID:        EventConfig{ID: LremovexattrEventID, ID32Bit: sys32lremovexattr, Name: "lremovexattr", Probes: []probe{probe{event: "lremovexattr", attach: sysCall, fn: "lremovexattr"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	FremovexattrEventID:        EventConfig{ID: FremovexattrEventID, ID32Bit: sys32fremovexattr, Name: "fremovexattr", Probes: []probe{probe{event: "fremovexattr", attach: sysCall, fn: "fremovexattr"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	TkillEventID:               EventConfig{ID: TkillEventID, ID32Bit: sys32tkill, Name: "tkill", Probes: []probe{probe{event: "tkill", attach: sysCall, fn: "tkill"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	TimeEventID:                EventConfig{ID: TimeEventID, ID32Bit: sys32time, Name: "time", Probes: []probe{probe{event: "time", attach: sysCall, fn: "time"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_tod"}},
	FutexEventID:               EventConfig{ID: FutexEventID, ID32Bit: sys32futex, Name: "futex", Probes: []probe{probe{event: "futex", attach: sysCall, fn: "futex"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_futex"}},
	SchedSetaffinityEventID:    EventConfig{ID: SchedSetaffinityEventID, ID32Bit: sys32sched_setaffinity, Name: "sched_setaffinity", Probes: []probe{probe{event: "sched_setaffinity", attach: sysCall, fn: "sched_setaffinity"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_sched"}},
	SchedGetaffinityEventID:    EventConfig{ID: SchedGetaffinityEventID, ID32Bit: sys32sched_getaffinity, Name: "sched_getaffinity", Probes: []probe{probe{event: "sched_getaffinity", attach: sysCall, fn: "sched_getaffinity"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_sched"}},
	SetThreadAreaEventID:       EventConfig{ID: SetThreadAreaEventID, ID32Bit: sys32set_thread_area, Name: "set_thread_area", Probes: []probe{probe{event: "set_thread_area", attach: sysCall, fn: "set_thread_area"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	IoSetupEventID:             EventConfig{ID: IoSetupEventID, ID32Bit: sys32io_setup, Name: "io_setup", Probes: []probe{probe{event: "io_setup", attach: sysCall, fn: "io_setup"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_async_io"}},
	IoDestroyEventID:           EventConfig{ID: IoDestroyEventID, ID32Bit: sys32io_destroy, Name: "io_destroy", Probes: []probe{probe{event: "io_destroy", attach: sysCall, fn: "io_destroy"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_async_io"}},
	IoGeteventsEventID:         EventConfig{ID: IoGeteventsEventID, ID32Bit: sys32io_getevents, Name: "io_getevents", Probes: []probe{probe{event: "io_getevents", attach: sysCall, fn: "io_getevents"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_async_io"}},
	IoSubmitEventID:            EventConfig{ID: IoSubmitEventID, ID32Bit: sys32io_submit, Name: "io_submit", Probes: []probe{probe{event: "io_submit", attach: sysCall, fn: "io_submit"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_async_io"}},
	IoCancelEventID:            EventConfig{ID: IoCancelEventID, ID32Bit: sys32io_cancel, Name: "io_cancel", Probes: []probe{probe{event: "io_cancel", attach: sysCall, fn: "io_cancel"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_async_io"}},
	GetThreadAreaEventID:       EventConfig{ID: GetThreadAreaEventID, ID32Bit: sys32get_thread_area, Name: "get_thread_area", Probes: []probe{probe{event: "get_thread_area", attach: sysCall, fn: "get_thread_area"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	LookupDcookieEventID:       EventConfig{ID: LookupDcookieEventID, ID32Bit: sys32lookup_dcookie, Name: "lookup_dcookie", Probes: []probe{probe{event: "lookup_dcookie", attach: sysCall, fn: "lookup_dcookie"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_dir_ops"}},
	EpollCreateEventID:         EventConfig{ID: EpollCreateEventID, ID32Bit: sys32epoll_create, Name: "epoll_create", Probes: []probe{probe{event: "epoll_create", attach: sysCall, fn: "epoll_create"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_mux_io"}},
	EpollCtlOldEventID:         EventConfig{ID: EpollCtlOldEventID, ID32Bit: sys32undefined, Name: "epoll_ctl_old", Probes: []probe{probe{event: "epoll_ctl_old", attach: sysCall, fn: "epoll_ctl_old"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_mux_io"}},
	EpollWaitOldEventID:        EventConfig{ID: EpollWaitOldEventID, ID32Bit: sys32undefined, Name: "epoll_wait_old", Probes: []probe{probe{event: "epoll_wait_old", attach: sysCall, fn: "epoll_wait_old"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_mux_io"}},
	RemapFilePagesEventID:      EventConfig{ID: RemapFilePagesEventID, ID32Bit: sys32remap_file_pages, Name: "remap_file_pages", Probes: []probe{probe{event: "remap_file_pages", attach: sysCall, fn: "remap_file_pages"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	...
	SetTidAddressEventID:       EventConfig{ID: SetTidAddressEventID, ID32Bit: sys32set_tid_address, Name: "set_tid_address", Probes: []probe{probe{event: "set_tid_address", attach: sysCall, fn: "set_tid_address"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	RestartSyscallEventID:      EventConfig{ID: RestartSyscallEventID, ID32Bit: sys32restart_syscall, Name: "restart_syscall", Probes: []probe{probe{event: "restart_syscall", attach: sysCall, fn: "restart_syscall"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	SemtimedopEventID:          EventConfig{ID: SemtimedopEventID, ID32Bit: sys32semtimedop_time64, Name: "semtimedop", Probes: []probe{probe{event: "semtimedop", attach: sysCall, fn: "semtimedop"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_sem"}},
	Fadvise64EventID:           EventConfig{ID: Fadvise64EventID, ID32Bit: sys32fadvise64, Name: "fadvise64", Probes: []probe{probe{event: "fadvise64", attach: sysCall, fn: "fadvise64"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs"}},
	TimerCreateEventID:         EventConfig{ID: TimerCreateEventID, ID32Bit: sys32timer_create, Name: "timer_create", Probes: []probe{probe{event: "timer_create", attach: sysCall, fn: "timer_create"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_timer"}},
	TimerSettimeEventID:        EventConfig{ID: TimerSettimeEventID, ID32Bit: sys32timer_settime, Name: "timer_settime", Probes: []probe{probe{event: "timer_settime", attach: sysCall, fn: "timer_settime"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_timer"}},
	TimerGettimeEventID:        EventConfig{ID: TimerGettimeEventID, ID32Bit: sys32timer_gettime, Name: "timer_gettime", Probes: []probe{probe{event: "timer_gettime", attach: sysCall, fn: "timer_gettime"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_timer"}},
	TimerGetoverrunEventID:     EventConfig{ID: TimerGetoverrunEventID, ID32Bit: sys32timer_getoverrun, Name: "timer_getoverrun", Probes: []probe{probe{event: "timer_getoverrun", attach: sysCall, fn: "timer_getoverrun"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_timer"}},
	TimerDeleteEventID:         EventConfig{ID: TimerDeleteEventID, ID32Bit: sys32timer_delete, Name: "timer_delete", Probes: []probe{probe{event: "timer_delete", attach: sysCall, fn: "timer_delete"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_timer"}},
	ClockSettimeEventID:        EventConfig{ID: ClockSettimeEventID, ID32Bit: sys32clock_settime, Name: "clock_settime", Probes: []probe{probe{event: "clock_settime", attach: sysCall, fn: "clock_settime"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_clock"}},
	ClockGettimeEventID:        EventConfig{ID: ClockGettimeEventID, ID32Bit: sys32clock_gettime, Name: "clock_gettime", Probes: []probe{probe{event: "clock_gettime", attach: sysCall, fn: "clock_gettime"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_clock"}},
	ClockGetresEventID:         EventConfig{ID: ClockGetresEventID, ID32Bit: sys32clock_getres, Name: "clock_getres", Probes: []probe{probe{event: "clock_getres", attach: sysCall, fn: "clock_getres"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_clock"}},
	ClockNanosleepEventID:      EventConfig{ID: ClockNanosleepEventID, ID32Bit: sys32clock_nanosleep, Name: "clock_nanosleep", Probes: []probe{probe{event: "clock_nanosleep", attach: sysCall, fn: "clock_nanosleep"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_clock"}},
	ExitGroupEventID:           EventConfig{ID: ExitGroupEventID, ID32Bit: sys32exit_group, Name: "exit_group", Probes: []probe{probe{event: "exit_group", attach: sysCall, fn: "exit_group"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_life"}},
	EpollWaitEventID:           EventConfig{ID: EpollWaitEventID, ID32Bit: sys32epoll_wait, Name: "epoll_wait", Probes: []probe{probe{event: "epoll_wait", attach: sysCall, fn: "epoll_wait"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_mux_io"}},
	EpollCtlEventID:            EventConfig{ID: EpollCtlEventID, ID32Bit: sys32epoll_ctl, Name: "epoll_ctl", Probes: []probe{probe{event: "epoll_ctl", attach: sysCall, fn: "epoll_ctl"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_mux_io"}},
	TgkillEventID:              EventConfig{ID: TgkillEventID, ID32Bit: sys32tgkill, Name: "tgkill", Probes: []probe{probe{event: "tgkill", attach: sysCall, fn: "tgkill"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	UtimesEventID:              EventConfig{ID: UtimesEventID, ID32Bit: sys32utimes, Name: "utimes", Probes: []probe{probe{event: "utimes", attach: sysCall, fn: "utimes"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	VserverEventID:             EventConfig{ID: VserverEventID, ID32Bit: sys32vserver, Name: "vserver", Probes: []probe{probe{event: "vserver", attach: sysCall, fn: "vserver"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	MbindEventID:               EventConfig{ID: MbindEventID, ID32Bit: sys32mbind, Name: "mbind", Probes: []probe{probe{event: "mbind", attach: sysCall, fn: "mbind"}}, EssentialEvent: false, Sets: []string{"syscalls", "system", "system_numa"}},
	SetMempolicyEventID:        EventConfig{ID: SetMempolicyEventID, ID32Bit: sys32set_mempolicy, Name: "set_mempolicy", Probes: []probe{probe{event: "set_mempolicy", attach: sysCall, fn: "set_mempolicy"}}, EssentialEvent: false, Sets: []string{"syscalls", "system", "system_numa"}},
	GetMempolicyEventID:        EventConfig{ID: GetMempolicyEventID, ID32Bit: sys32get_mempolicy, Name: "get_mempolicy", Probes: []probe{probe{event: "get_mempolicy", attach: sysCall, fn: "get_mempolicy"}}, EssentialEvent: false, Sets: []string{"syscalls", "system", "system_numa"}},
	MqOpenEventID:              EventConfig{ID: MqOpenEventID, ID32Bit: sys32mq_open, Name: "mq_open", Probes: []probe{probe{event: "mq_open", attach: sysCall, fn: "mq_open"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_msgq"}},
	MqUnlinkEventID:            EventConfig{ID: MqUnlinkEventID, ID32Bit: sys32mq_unlink, Name: "mq_unlink", Probes: []probe{probe{event: "mq_unlink", attach: sysCall, fn: "mq_unlink"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_msgq"}},
	MqTimedsendEventID:         EventConfig{ID: MqTimedsendEventID, ID32Bit: sys32mq_timedsend, Name: "mq_timedsend", Probes: []probe{probe{event: "mq_timedsend", attach: sysCall, fn: "mq_timedsend"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_msgq"}},
	MqTimedreceiveEventID:      EventConfig{ID: MqTimedreceiveEventID, ID32Bit: sys32mq_timedreceive, Name: "mq_timedreceive", Probes: []probe{probe{event: "mq_timedreceive", attach: sysCall, fn: "mq_timedreceive"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_msgq"}},
	MqNotifyEventID:            EventConfig{ID: MqNotifyEventID, ID32Bit: sys32mq_notify, Name: "mq_notify", Probes: []probe{probe{event: "mq_notify", attach: sysCall, fn: "mq_notify"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_msgq"}},
	MqGetsetattrEventID:        EventConfig{ID: MqGetsetattrEventID, ID32Bit: sys32mq_getsetattr, Name: "mq_getsetattr", Probes: []probe{probe{event: "mq_getsetattr", attach: sysCall, fn: "mq_getsetattr"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_msgq"}},
	KexecLoadEventID:           EventConfig{ID: KexecLoadEventID, ID32Bit: sys32kexec_load, Name: "kexec_load", Probes: []probe{probe{event: "kexec_load", attach: sysCall, fn: "kexec_load"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	WaitidEventID:              EventConfig{ID: WaitidEventID, ID32Bit: sys32waitid, Name: "waitid", Probes: []probe{probe{event: "waitid", attach: sysCall, fn: "waitid"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_life"}},
	AddKeyEventID:              EventConfig{ID: AddKeyEventID, ID32Bit: sys32add_key, Name: "add_key", Probes: []probe{probe{event: "add_key", attach: sysCall, fn: "add_key"}}, EssentialEvent: false, Sets: []string{"syscalls", "system", "system_keys"}},
	RequestKeyEventID:          EventConfig{ID: RequestKeyEventID, ID32Bit: sys32request_key, Name: "request_key", Probes: []probe{probe{event: "request_key", attach: sysCall, fn: "request_key"}}, EssentialEvent: false, Sets: []string{"syscalls", "system", "system_keys"}},
	KeyctlEventID:              EventConfig{ID: KeyctlEventID, ID32Bit: sys32keyctl, Name: "keyctl", Probes: []probe{probe{event: "keyctl", attach: sysCall, fn: "keyctl"}}, EssentialEvent: false, Sets: []string{"syscalls", "system", "system_keys"}},
	IoprioSetEventID:           EventConfig{ID: IoprioSetEventID, ID32Bit: sys32ioprio_set, Name: "ioprio_set", Probes: []probe{probe{event: "ioprio_set", attach: sysCall, fn: "ioprio_set"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_sched"}},
	IoprioGetEventID:           EventConfig{ID: IoprioGetEventID, ID32Bit: sys32ioprio_get, Name: "ioprio_get", Probes: []probe{probe{event: "ioprio_get", attach: sysCall, fn: "ioprio_get"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_sched"}},
	InotifyInitEventID:         EventConfig{ID: InotifyInitEventID, ID32Bit: sys32inotify_init, Name: "inotify_init", Probes: []probe{probe{event: "inotify_init", attach: sysCall, fn: "inotify_init"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_monitor"}},
	InotifyAddWatchEventID:     EventConfig{ID: InotifyAddWatchEventID, ID32Bit: sys32inotify_add_watch, Name: "inotify_add_watch", Probes: []probe{probe{event: "inotify_add_watch", attach: sysCall, fn: "inotify_add_watch"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_monitor"}},
	InotifyRmWatchEventID:      EventConfig{ID: InotifyRmWatchEventID, ID32Bit: sys32inotify_rm_watch, Name: "inotify_rm_watch", Probes: []probe{probe{event: "inotify_rm_watch", attach: sysCall, fn: "inotify_rm_watch"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_monitor"}},
	MigratePagesEventID:        EventConfig{ID: MigratePagesEventID, ID32Bit: sys32migrate_pages, Name: "migrate_pages", Probes: []probe{probe{event: "migrate_pages", attach: sysCall, fn: "migrate_pages"}}, EssentialEvent: false, Sets: []string{"syscalls", "system", "system_numa"}},
	...
	MkdiratEventID:             EventConfig{ID: MkdiratEventID, ID32Bit: sys32mkdirat, Name: "mkdirat", Probes: []probe{probe{event: "mkdirat", attach: sysCall, fn: "mkdirat"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_dir_ops"}},
	...
	FutimesatEventID:           EventConfig{ID: FutimesatEventID, ID32Bit: sys32futimesat, Name: "futimesat", Probes: []probe{probe{event: "futimesat", attach: sysCall, fn: "futimesat"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	NewfstatatEventID:          EventConfig{ID: NewfstatatEventID, ID32Bit: sys32fstatat64, Name: "newfstatat", Probes: []probe{probe{event: "newfstatat", attach: sysCall, fn: "newfstatat"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	...
	RenameatEventID:            EventConfig{ID: RenameatEventID, ID32Bit: sys32renameat, Name: "renameat", Probes: []probe{probe{event: "renameat", attach: sysCall, fn: "renameat"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_ops"}},
	LinkatEventID:              EventConfig{ID: LinkatEventID, ID32Bit: sys32linkat, Name: "linkat", Probes: []probe{probe{event: "linkat", attach: sysCall, fn: "linkat"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_link_ops"}},
	...
	ReadlinkatEventID:          EventConfig{ID: ReadlinkatEventID, ID32Bit: sys32readlinkat, Name: "readlinkat", Probes: []probe{probe{event: "readlinkat", attach: sysCall, fn: "readlinkat"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_link_ops"}},
	...
	Pselect6EventID:            EventConfig{ID: Pselect6EventID, ID32Bit: sys32pselect6, Name: "pselect6", Probes: []probe{probe{event: "pselect6", attach: sysCall, fn: "pselect6"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_mux_io"}},
	PpollEventID:               EventConfig{ID: PpollEventID, ID32Bit: sys32ppoll, Name: "ppoll", Probes: []probe{probe{event: "ppoll", attach: sysCall, fn: "ppoll"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_mux_io"}},
	UnshareEventID:             EventConfig{ID: UnshareEventID, ID32Bit: sys32unshare, Name: "unshare", Probes: []probe{probe{event: "unshare", attach: sysCall, fn: "unshare"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	SetRobustListEventID:       EventConfig{ID: SetRobustListEventID, ID32Bit: sys32set_robust_list, Name: "set_robust_list", Probes: []probe{probe{event: "set_robust_list", attach: sysCall, fn: "set_robust_list"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_futex"}},
	GetRobustListEventID:       EventConfig{ID: GetRobustListEventID, ID32Bit: sys32get_robust_list, Name: "get_robust_list", Probes: []probe{probe{event: "get_robust_list", attach: sysCall, fn: "get_robust_list"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_futex"}},
	SpliceEventID:              EventConfig{ID: SpliceEventID, ID32Bit: sys32splice, Name: "splice", Probes: []probe{probe{event: "splice", attach: sysCall, fn: "splice"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_pipe"}},
	TeeEventID:                 EventConfig{ID: TeeEventID, ID32Bit: sys32tee, Name: "tee", Probes: []probe{probe{event: "tee", attach: sysCall, fn: "tee"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_pipe"}},
	SyncFileRangeEventID:       EventConfig{ID: SyncFileRangeEventID, ID32Bit: sys32sync_file_range, Name: "sync_file_range", Probes: []probe{probe{event: "sync_file_range", attach: sysCall, fn: "sync_file_range"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_sync"}},
	VmspliceEventID:            EventConfig{ID: VmspliceEventID, ID32Bit: sys32vmsplice, Name: "vmsplice", Probes: []probe{probe{event: "vmsplice", attach: sysCall, fn: "vmsplice"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_pipe"}},
	MovePagesEventID:           EventConfig{ID: MovePagesEventID, ID32Bit: sys32move_pages, Name: "move_pages", Probes: []probe{probe{event: "move_pages", attach: sysCall, fn: "move_pages"}}, EssentialEvent: false, Sets: []string{"syscalls", "system", "system_numa"}},
	UtimensatEventID:           EventConfig{ID: UtimensatEventID, ID32Bit: sys32utimensat, Name: "utimensat", Probes: []probe{probe{event: "utimensat", attach: sysCall, fn: "utimensat"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	EpollPwaitEventID:          EventConfig{ID: EpollPwaitEventID, ID32Bit: sys32epoll_pwait, Name: "epoll_pwait", Probes: []probe{probe{event: "epoll_pwait", attach: sysCall, fn: "epoll_pwait"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_mux_io"}},
	SignalfdEventID:            EventConfig{ID: SignalfdEventID, ID32Bit: sys32signalfd, Name: "signalfd", Probes: []probe{probe{event: "signalfd", attach: sysCall, fn: "signalfd"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	TimerfdCreateEventID:       EventConfig{ID: TimerfdCreateEventID, ID32Bit: sys32timerfd_create, Name: "timerfd_create", Probes: []probe{probe{event: "timerfd_create", attach: sysCall, fn: "timerfd_create"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_timer"}},
	EventfdEventID:             EventConfig{ID: EventfdEventID, ID32Bit: sys32eventfd, Name: "eventfd", Probes: []probe{probe{event: "eventfd", attach: sysCall, fn: "eventfd"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	FallocateEventID:           EventConfig{ID: FallocateEventID, ID32Bit: sys32fallocate, Name: "fallocate", Probes: []probe{probe{event: "fallocate", attach: sysCall, fn: "fallocate"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_ops"}},
	TimerfdSettimeEventID:      EventConfig{ID: TimerfdSettimeEventID, ID32Bit: sys32timerfd_settime, Name: "timerfd_settime", Probes: []probe{probe{event: "timerfd_settime", attach: sysCall, fn: "timerfd_settime"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_timer"}},
	TimerfdGettimeEventID:      EventConfig{ID: TimerfdGettimeEventID, ID32Bit: sys32timerfd_gettime, Name: "timerfd_gettime", Probes: []probe{probe{event: "timerfd_gettime", attach: sysCall, fn: "timerfd_gettime"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_timer"}},
	...
	Signalfd4EventID:           EventConfig{ID: Signalfd4EventID, ID32Bit: sys32signalfd4, Name: "signalfd4", Probes: []probe{probe{event: "signalfd4", attach: sysCall, fn: "signalfd4"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	Eventfd2EventID:            EventConfig{ID: Eventfd2EventID, ID32Bit: sys32eventfd2, Name: "eventfd2", Probes: []probe{probe{event: "eventfd2", attach: sysCall, fn: "eventfd2"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	EpollCreate1EventID:        EventConfig{ID: EpollCreate1EventID, ID32Bit: sys32epoll_create1, Name: "epoll_create1", Probes: []probe{probe{event: "epoll_create1", attach: sysCall, fn: "epoll_create1"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_mux_io"}},
	...
	Pipe2EventID:               EventConfig{ID: Pipe2EventID, ID32Bit: sys32pipe2, Name: "pipe2", Probes: []probe{probe{event: "pipe2", attach: sysCall, fn: "pipe2"}}, EssentialEvent: false, Sets: []string{"syscalls", "ipc", "ipc_pipe"}},
	InotifyInit1EventID:        EventConfig{ID: InotifyInit1EventID, ID32Bit: sys32inotify_init1, Name: "inotify_init1", Probes: []probe{probe{event: "inotify_init1", attach: sysCall, fn: "inotify_init1"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_monitor"}},
	PreadvEventID:              EventConfig{ID: PreadvEventID, ID32Bit: sys32preadv, Name: "preadv", Probes: []probe{probe{event: "preadv", attach: sysCall, fn: "preadv"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_read_write"}},
	PwritevEventID:             EventConfig{ID: PwritevEventID, ID32Bit: sys32pwritev, Name: "pwritev", Probes: []probe{probe{event: "pwritev", attach: sysCall, fn: "pwritev"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_read_write"}},
	RtTgsigqueueinfoEventID:    EventConfig{ID: RtTgsigqueueinfoEventID, ID32Bit: sys32rt_tgsigqueueinfo, Name: "rt_tgsigqueueinfo", Probes: []probe{probe{event: "rt_tgsigqueueinfo", attach: sysCall, fn: "rt_tgsigqueueinfo"}}, EssentialEvent: false, Sets: []string{"syscalls", "signals"}},
	PerfEventOpenEventID:       EventConfig{ID: PerfEventOpenEventID, ID32Bit: sys32perf_event_open, Name: "perf_event_open", Probes: []probe{probe{event: "perf_event_open", attach: sysCall, fn: "perf_event_open"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	RecvmmsgEventID:            EventConfig{ID: RecvmmsgEventID, ID32Bit: sys32recvmmsg, Name: "recvmmsg", Probes: []probe{probe{event: "recvmmsg", attach: sysCall, fn: "recvmmsg"}}, EssentialEvent: false, Sets: []string{"syscalls", "net", "net_snd_rcv"}},
	FanotifyInitEventID:        EventConfig{ID: FanotifyInitEventID, ID32Bit: sys32fanotify_init, Name: "fanotify_init", Probes: []probe{probe{event: "fanotify_init", attach: sysCall, fn: "fanotify_init"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_monitor"}},
	FanotifyMarkEventID:        EventConfig{ID: FanotifyMarkEventID, ID32Bit: sys32fanotify_mark, Name: "fanotify_mark", Probes: []probe{probe{event: "fanotify_mark", attach: sysCall, fn: "fanotify_mark"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_monitor"}},
	Prlimit64EventID:           EventConfig{ID: Prlimit64EventID, ID32Bit: sys32prlimit64, Name: "prlimit64", Probes: []probe{probe{event: "prlimit64", attach: sysCall, fn: "prlimit64"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	NameToHandleAtEventID:      EventConfig{ID: NameToHandleAtEventID, ID32Bit: sys32name_to_handle_at, Name: "name_to_handle_at", Probes: []probe{probe{event: "name_to_handle_at", attach: sysCall, fn: "name_to_handle_at"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_ops"}},
	OpenByHandleAtEventID:      EventConfig{ID: OpenByHandleAtEventID, ID32Bit: sys32open_by_handle_at, Name: "open_by_handle_at", Probes: []probe{probe{event: "open_by_handle_at", attach: sysCall, fn: "open_by_handle_at"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_ops"}},
	ClockAdjtimeEventID:        EventConfig{ID: ClockAdjtimeEventID, ID32Bit: sys32clock_adjtime, Name: "clock_adjtime", Probes: []probe{probe{event: "clock_adjtime", attach: sysCall, fn: "clock_adjtime"}}, EssentialEvent: false, Sets: []string{"syscalls", "time", "time_clock"}},
	SyncfsEventID:              EventConfig{ID: SyncfsEventID, ID32Bit: sys32syncfs, Name: "syncfs", Probes: []probe{probe{event: "syncfs", attach: sysCall, fn: "syncfs"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_sync"}},
	SendmmsgEventID:            EventConfig{ID: SendmmsgEventID, ID32Bit: sys32sendmmsg, Name: "sendmmsg", Probes: []probe{probe{event: "sendmmsg", attach: sysCall, fn: "sendmmsg"}}, EssentialEvent: false, Sets: []string{"syscalls", "net", "net_snd_rcv"}},
	SetnsEventID:               EventConfig{ID: SetnsEventID, ID32Bit: sys32setns, Name: "setns", Probes: []probe{probe{event: "setns", attach: sysCall, fn: "setns"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	GetcpuEventID:              EventConfig{ID: GetcpuEventID, ID32Bit: sys32getcpu, Name: "getcpu", Probes: []probe{probe{event: "getcpu", attach: sysCall, fn: "getcpu"}}, EssentialEvent: false, Sets: []string{"syscalls", "system", "system_numa"}},
	...
	KcmpEventID:                EventConfig{ID: KcmpEventID, ID32Bit: sys32kcmp, Name: "kcmp", Probes: []probe{probe{event: "kcmp", attach: sysCall, fn: "kcmp"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	...
	SchedSetattrEventID:        EventConfig{ID: SchedSetattrEventID, ID32Bit: sys32sched_setattr, Name: "sched_setattr", Probes: []probe{probe{event: "sched_setattr", attach: sysCall, fn: "sched_setattr"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_sched"}},
	SchedGetattrEventID:        EventConfig{ID: SchedGetattrEventID, ID32Bit: sys32sched_getattr, Name: "sched_getattr", Probes: []probe{probe{event: "sched_getattr", attach: sysCall, fn: "sched_getattr"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_sched"}},
	Renameat2EventID:           EventConfig{ID: Renameat2EventID, ID32Bit: sys32renameat2, Name: "renameat2", Probes: []probe{probe{event: "renameat2", attach: sysCall, fn: "renameat2"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_ops"}},
	SeccompEventID:             EventConfig{ID: SeccompEventID, ID32Bit: sys32seccomp, Name: "seccomp", Probes: []probe{probe{event: "seccomp", attach: sysCall, fn: "seccomp"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc"}},
	GetrandomEventID:           EventConfig{ID: GetrandomEventID, ID32Bit: sys32getrandom, Name: "getrandom", Probes: []probe{probe{event: "getrandom", attach: sysCall, fn: "getrandom"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs"}},
	...
	KexecFileLoadEventID:       EventConfig{ID: KexecFileLoadEventID, ID32Bit: sys32undefined, Name: "kexec_file_load", Probes: []probe{probe{event: "kexec_file_load", attach: sysCall, fn: "kexec_file_load"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	BpfEventID:                 EventConfig{ID: BpfEventID, ID32Bit: sys32bpf, Name: "bpf", Probes: []probe{probe{event: "bpf", attach: sysCall, fn: "bpf"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	...
	UserfaultfdEventID:         EventConfig{ID: UserfaultfdEventID, ID32Bit: sys32userfaultfd, Name: "userfaultfd", Probes: []probe{probe{event: "userfaultfd", attach: sysCall, fn: "userfaultfd"}}, EssentialEvent: false, Sets: []string{"syscalls", "system"}},
	MembarrierEventID:          EventConfig{ID: MembarrierEventID, ID32Bit: sys32membarrier, Name: "membarrier", Probes: []probe{probe{event: "membarrier", attach: sysCall, fn: "membarrier"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_mem"}},
	Mlock2EventID:              EventConfig{ID: Mlock2EventID, ID32Bit: sys32mlock2, Name: "mlock2", Probes: []probe{probe{event: "mlock2", attach: sysCall, fn: "mlock2"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_mem"}},
	CopyFileRangeEventID:       EventConfig{ID: CopyFileRangeEventID, ID32Bit: sys32copy_file_range, Name: "copy_file_range", Probes: []probe{probe{event: "copy_file_range", attach: sysCall, fn: "copy_file_range"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_read_write"}},
	Preadv2EventID:             EventConfig{ID: Preadv2EventID, ID32Bit: sys32preadv2, Name: "preadv2", Probes: []probe{probe{event: "preadv2", attach: sysCall, fn: "preadv2"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_read_write"}},
	Pwritev2EventID:            EventConfig{ID: Pwritev2EventID, ID32Bit: sys32pwritev2, Name: "pwritev2", Probes: []probe{probe{event: "pwritev2", attach: sysCall, fn: "pwritev2"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_read_write"}},
	...
	PkeyAllocEventID:           EventConfig{ID: PkeyAllocEventID, ID32Bit: sys32pkey_alloc, Name: "pkey_alloc", Probes: []probe{probe{event: "pkey_alloc", attach: sysCall, fn: "pkey_alloc"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_mem"}},
	PkeyFreeEventID:            EventConfig{ID: PkeyFreeEventID, ID32Bit: sys32pkey_free, Name: "pkey_free", Probes: []probe{probe{event: "pkey_free", attach: sysCall, fn: "pkey_free"}}, EssentialEvent: false, Sets: []string{"syscalls", "proc", "proc_mem"}},
	StatxEventID:               EventConfig{ID: StatxEventID, ID32Bit: sys32statx, Name: "statx", Probes: []probe{probe{event: "statx", attach: sysCall, fn: "statx"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_file_attr"}},
	IoPgeteventsEventID:        EventConfig{ID: IoPgeteventsEventID, ID32Bit: sys32io_pgetevents, Name: "io_pgetevents", Probes: []probe{probe{event: "io_pgetevents", attach: sysCall, fn: "io_pgetevents"}}, EssentialEvent: false, Sets: []string{"syscalls", "fs", "fs_async_io"}},
	RseqEventID:                EventConfig{ID: RseqEventID, ID32Bit: sys32rseq, Name: "rseq", Probes: []probe{probe{event: "rseq", attach: sysCall, fn: "rseq"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
