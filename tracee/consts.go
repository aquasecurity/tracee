...
var EventsIDToEvent = map[int32]EventConfig{
	ReadEventID:                EventConfig{ID: ReadEventID, Name: "read", Probes: []probe{probe{event: "read", attach: sysCall, fn: "read"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	WriteEventID:               EventConfig{ID: WriteEventID, Name: "write", Probes: []probe{probe{event: "write", attach: sysCall, fn: "write"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	OpenEventID:                EventConfig{ID: OpenEventID, Name: "open", Probes: []probe{probe{event: "open", attach: sysCall, fn: "open"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	CloseEventID:               EventConfig{ID: CloseEventID, Name: "close", Probes: []probe{probe{event: "close", attach: sysCall, fn: "close"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	StatEventID:                EventConfig{ID: StatEventID, Name: "stat", Probes: []probe{probe{event: "newstat", attach: sysCall, fn: "newstat"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	FstatEventID:               EventConfig{ID: FstatEventID, Name: "fstat", Probes: []probe{probe{event: "newfstat", attach: sysCall, fn: "newfstat"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	LstatEventID:               EventConfig{ID: LstatEventID, Name: "lstat", Probes: []probe{probe{event: "newlstat", attach: sysCall, fn: "newlstat"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	LseekEventID:               EventConfig{ID: LseekEventID, Name: "lseek", Probes: []probe{probe{event: "lseek", attach: sysCall, fn: "lseek"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	MmapEventID:                EventConfig{ID: MmapEventID, Name: "mmap", Probes: []probe{probe{event: "mmap", attach: sysCall, fn: "mmap"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	MprotectEventID:            EventConfig{ID: MprotectEventID, Name: "mprotect", Probes: []probe{probe{event: "mprotect", attach: sysCall, fn: "mprotect"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	MunmapEventID:              EventConfig{ID: MunmapEventID, Name: "munmap", Probes: []probe{probe{event: "munmap", attach: sysCall, fn: "munmap"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	BrkEventID:                 EventConfig{ID: BrkEventID, Name: "brk", Probes: []probe{probe{event: "brk", attach: sysCall, fn: "brk"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	...
	IoctlEventID:               EventConfig{ID: IoctlEventID, Name: "ioctl", Probes: []probe{probe{event: "ioctl", attach: sysCall, fn: "ioctl"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	Pread64EventID:             EventConfig{ID: Pread64EventID, Name: "pread64", Probes: []probe{probe{event: "pread64", attach: sysCall, fn: "pread64"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	Pwrite64EventID:            EventConfig{ID: Pwrite64EventID, Name: "pwrite64", Probes: []probe{probe{event: "pwrite64", attach: sysCall, fn: "pwrite64"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	...
	AccessEventID:              EventConfig{ID: AccessEventID, Name: "access", Probes: []probe{probe{event: "access", attach: sysCall, fn: "access"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	SchedYieldEventID:          EventConfig{ID: SchedYieldEventID, Name: "sched_yield", Probes: []probe{probe{event: "sched_yield", attach: sysCall, fn: "sched_yield"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	...
	MsyncEventID:               EventConfig{ID: MsyncEventID, Name: "msync", Probes: []probe{probe{event: "msync", attach: sysCall, fn: "msync"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	...
	MadviseEventID:             EventConfig{ID: MadviseEventID, Name: "madvise", Probes: []probe{probe{event: "madvise", attach: sysCall, fn: "madvise"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	...
	DupEventID:                 EventConfig{ID: DupEventID, Name: "dup", Probes: []probe{probe{event: "dup", attach: sysCall, fn: "dup"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	Dup2EventID:                EventConfig{ID: Dup2EventID, Name: "dup2", Probes: []probe{probe{event: "dup2", attach: sysCall, fn: "dup2"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	GetpidEventID:              EventConfig{ID: GetpidEventID, Name: "getpid", Probes: []probe{probe{event: "getpid", attach: sysCall, fn: "getpid"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	...
	SocketEventID:              EventConfig{ID: SocketEventID, Name: "socket", Probes: []probe{probe{event: "socket", attach: sysCall, fn: "socket"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	ConnectEventID:             EventConfig{ID: ConnectEventID, Name: "connect", Probes: []probe{probe{event: "connect", attach: sysCall, fn: "connect"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	AcceptEventID:              EventConfig{ID: AcceptEventID, Name: "accept", Probes: []probe{probe{event: "accept", attach: sysCall, fn: "accept"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	SendtoEventID:              EventConfig{ID: SendtoEventID, Name: "sendto", Probes: []probe{probe{event: "sendto", attach: sysCall, fn: "sendto"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	RecvfromEventID:            EventConfig{ID: RecvfromEventID, Name: "recvfrom", Probes: []probe{probe{event: "recvfrom", attach: sysCall, fn: "recvfrom"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	...
	BindEventID:                EventConfig{ID: BindEventID, Name: "bind", Probes: []probe{probe{event: "bind", attach: sysCall, fn: "bind"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	ListenEventID:              EventConfig{ID: ListenEventID, Name: "listen", Probes: []probe{probe{event: "listen", attach: sysCall, fn: "listen"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	GetsocknameEventID:         EventConfig{ID: GetsocknameEventID, Name: "getsockname", Probes: []probe{probe{event: "getsockname", attach: sysCall, fn: "getsockname"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	CloneEventID:               EventConfig{ID: CloneEventID, Name: "clone", Probes: []probe{probe{event: "clone", attach: sysCall, fn: "clone"}}, EssentialEvent: true, Sets: []string{"default", "syscalls"}},
	ForkEventID:                EventConfig{ID: ForkEventID, Name: "fork", Probes: []probe{probe{event: "fork", attach: sysCall, fn: "fork"}}, EssentialEvent: true, Sets: []string{"default", "syscalls"}},
	VforkEventID:               EventConfig{ID: VforkEventID, Name: "vfork", Probes: []probe{probe{event: "vfork", attach: sysCall, fn: "vfork"}}, EssentialEvent: true, Sets: []string{"default", "syscalls"}},
	ExecveEventID:              EventConfig{ID: ExecveEventID, Name: "execve", Probes: []probe{probe{event: "execve", attach: sysCall, fn: "execve"}}, EssentialEvent: true, Sets: []string{"default", "syscalls"}},
	...
	KillEventID:                EventConfig{ID: KillEventID, Name: "kill", Probes: []probe{probe{event: "kill", attach: sysCall, fn: "kill"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	GetdentsEventID:            EventConfig{ID: GetdentsEventID, Name: "getdents", Probes: []probe{probe{event: "getdents", attach: sysCall, fn: "getdents"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	CreatEventID:               EventConfig{ID: CreatEventID, Name: "creat", Probes: []probe{probe{event: "creat", attach: sysCall, fn: "creat"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	UnlinkEventID:              EventConfig{ID: UnlinkEventID, Name: "unlink", Probes: []probe{probe{event: "unlink", attach: sysCall, fn: "unlink"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	SymlinkEventID:             EventConfig{ID: SymlinkEventID, Name: "symlink", Probes: []probe{probe{event: "symlink", attach: sysCall, fn: "symlink"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	ChmodEventID:               EventConfig{ID: ChmodEventID, Name: "chmod", Probes: []probe{probe{event: "chmod", attach: sysCall, fn: "chmod"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	FchmodEventID:              EventConfig{ID: FchmodEventID, Name: "fchmod", Probes: []probe{probe{event: "fchmod", attach: sysCall, fn: "fchmod"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	ChownEventID:               EventConfig{ID: ChownEventID, Name: "chown", Probes: []probe{probe{event: "chown", attach: sysCall, fn: "chown"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	FchownEventID:              EventConfig{ID: FchownEventID, Name: "fchown", Probes: []probe{probe{event: "fchown", attach: sysCall, fn: "fchown"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	LchownEventID:              EventConfig{ID: LchownEventID, Name: "lchown", Probes: []probe{probe{event: "lchown", attach: sysCall, fn: "lchown"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	PtraceEventID:              EventConfig{ID: PtraceEventID, Name: "ptrace", Probes: []probe{probe{event: "ptrace", attach: sysCall, fn: "ptrace"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	SetuidEventID:              EventConfig{ID: SetuidEventID, Name: "setuid", Probes: []probe{probe{event: "setuid", attach: sysCall, fn: "setuid"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	SetgidEventID:              EventConfig{ID: SetgidEventID, Name: "setgid", Probes: []probe{probe{event: "setgid", attach: sysCall, fn: "setgid"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	GetppidEventID:             EventConfig{ID: GetppidEventID, Name: "getppid", Probes: []probe{probe{event: "getppid", attach: sysCall, fn: "getppid"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	...
	SetreuidEventID:            EventConfig{ID: SetreuidEventID, Name: "setreuid", Probes: []probe{probe{event: "setreuid", attach: sysCall, fn: "setreuid"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	SetregidEventID:            EventConfig{ID: SetregidEventID, Name: "setregid", Probes: []probe{probe{event: "setregid", attach: sysCall, fn: "setregid"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	SetfsuidEventID:            EventConfig{ID: SetfsuidEventID, Name: "setfsuid", Probes: []probe{probe{event: "setfsuid", attach: sysCall, fn: "setfsuid"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	SetfsgidEventID:            EventConfig{ID: SetfsgidEventID, Name: "setfsgid", Probes: []probe{probe{event: "setfsgid", attach: sysCall, fn: "setfsgid"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	MknodEventID:               EventConfig{ID: MknodEventID, Name: "mknod", Probes: []probe{probe{event: "mknod", attach: sysCall, fn: "mknod"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	PrctlEventID:               EventConfig{ID: PrctlEventID, Name: "prctl", Probes: []probe{probe{event: "prctl", attach: sysCall, fn: "prctl"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	MountEventID:               EventConfig{ID: MountEventID, Name: "mount", Probes: []probe{probe{event: "mount", attach: sysCall, fn: "mount"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	UmountEventID:              EventConfig{ID: UmountEventID, Name: "umount", Probes: []probe{probe{event: "umount", attach: sysCall, fn: "umount"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	InitModuleEventID:          EventConfig{ID: InitModuleEventID, Name: "init_module", Probes: []probe{probe{event: "init_module", attach: sysCall, fn: "init_module"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	DeleteModuleEventID:        EventConfig{ID: DeleteModuleEventID, Name: "delete_module", Probes: []probe{probe{event: "delete_module", attach: sysCall, fn: "delete_module"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	GettidEventID:              EventConfig{ID: GettidEventID, Name: "gettid", Probes: []probe{probe{event: "gettid", attach: sysCall, fn: "gettid"}}, EssentialEvent: false, Sets: []string{"syscalls"}},
	...
	Getdents64EventID:          EventConfig{ID: Getdents64EventID, Name: "getdents64", Probes: []probe{probe{event: "getdents64", attach: sysCall, fn: "getdents64"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	OpenatEventID:              EventConfig{ID: OpenatEventID, Name: "openat", Probes: []probe{probe{event: "openat", attach: sysCall, fn: "openat"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	MknodatEventID:             EventConfig{ID: MknodatEventID, Name: "mknodat", Probes: []probe{probe{event: "mknodat", attach: sysCall, fn: "mknodat"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	FchownatEventID:            EventConfig{ID: FchownatEventID, Name: "fchownat", Probes: []probe{probe{event: "fchownat", attach: sysCall, fn: "fchownat"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	UnlinkatEventID:            EventConfig{ID: UnlinkatEventID, Name: "unlinkat", Probes: []probe{probe{event: "unlinkat", attach: sysCall, fn: "unlinkat"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	SymlinkatEventID:           EventConfig{ID: SymlinkatEventID, Name: "symlinkat", Probes: []probe{probe{event: "symlinkat", attach: sysCall, fn: "symlinkat"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	FchmodatEventID:            EventConfig{ID: FchmodatEventID, Name: "fchmodat", Probes: []probe{probe{event: "fchmodat", attach: sysCall, fn: "fchmodat"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	FaccessatEventID:           EventConfig{ID: FaccessatEventID, Name: "faccessat", Probes: []probe{probe{event: "faccessat", attach: sysCall, fn: "faccessat"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	Accept4EventID:             EventConfig{ID: Accept4EventID, Name: "accept4", Probes: []probe{probe{event: "accept4", attach: sysCall, fn: "accept4"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	Dup3EventID:                EventConfig{ID: Dup3EventID, Name: "dup3", Probes: []probe{probe{event: "dup3", attach: sysCall, fn: "dup3"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	ProcessVmReadvEventID:      EventConfig{ID: ProcessVmReadvEventID, Name: "process_vm_readv", Probes: []probe{probe{event: "process_vm_readv", attach: sysCall, fn: "process_vm_readv"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	ProcessVmWritevEventID:     EventConfig{ID: ProcessVmWritevEventID, Name: "process_vm_writev", Probes: []probe{probe{event: "process_vm_writev", attach: sysCall, fn: "process_vm_writev"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	FinitModuleEventID:         EventConfig{ID: FinitModuleEventID, Name: "finit_module", Probes: []probe{probe{event: "finit_module", attach: sysCall, fn: "finit_module"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	MemfdCreateEventID:         EventConfig{ID: MemfdCreateEventID, Name: "memfd_create", Probes: []probe{probe{event: "memfd_create", attach: sysCall, fn: "memfd_create"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
	...
	ExecveatEventID:            EventConfig{ID: ExecveatEventID, Name: "execveat", Probes: []probe{probe{event: "execveat", attach: sysCall, fn: "execveat"}}, EssentialEvent: true, Sets: []string{"default", "syscalls"}},
	...
	PkeyMprotectEventID:        EventConfig{ID: PkeyMprotectEventID, Name: "pkey_mprotect", Probes: []probe{probe{event: "pkey_mprotect", attach: sysCall, fn: "pkey_mprotect"}}, EssentialEvent: false, Sets: []string{"default", "syscalls"}},
