...
func (d *SensitiveFileAccess) OnEvent(ctx context.Context, event *v1beta1.Event) ([]*v1beta1.Event, error) {
	...
	// Create detection event (Threat, DetectedFrom, ProcessAncestry auto-populated)
...
**CreateEventFromBase** creates a new event with copied context:

```go
func (d *MyDetector) OnEvent(ctx context.Context, event *v1beta1.Event) ([]*v1beta1.Event, error) {
	// Create output event (copies Timestamp, Workload, Policies)
	detection := v1beta1.CreateEventFromBase(event)
	...
	// Engine will populate Name, ID, Threat, DetectedFrom, ProcessAncestry
	return []*v1beta1.Event{detection}, nil
}
```
...
```go
func (d *FileAccessDetector) OnEvent(ctx context.Context, event *v1beta1.Event) ([]*v1beta1.Event, error) {
...
```go
func (d *ContainerEscapeDetector) OnEvent(ctx context.Context, event *v1beta1.Event) ([]*v1beta1.Event, error) {
...
func (d *MyDetector) OnEvent(ctx context.Context, event *v1beta1.Event) ([]*v1beta1.Event, error) {
	...
	// No need to set detection.Threat - engine does it automatically

	return []*v1beta1.Event{detection}, nil
}
```

!!! Important "Threat is Immutable"
    ThreatMetadata is **always static** (defined once in GetDefinition()). Never modify `Threat` at runtime. For runtime-specific context, use `Event.Data` fields instead.

**Wrong** (don't do this):
```go
detection.Threat.Properties["runtime_data"] = value  // Don't modify Threat
```

**Right** (do this):
```go
detection.Data = append(detection.Data,
	v1beta1.NewStringValue("runtime_context", value))  // Use Event.Data
```
...
**What it does**: Engine queries the process store and populates `Event.Workload.Process.Ancestors` with up to 5 levels of ancestors.

```go
AutoPopulate: detection.AutoPopulateFields{
	ProcessAncestry: true,  // Engine queries process store
},
```
...
func (d *MyDetector) OnEvent(ctx context.Context, event *v1beta1.Event) ([]*v1beta1.Event, error) {
	detection := v1beta1.CreateEventFromBase(event)
	// Threat, DetectedFrom, ProcessAncestry all auto-populated
	return []*v1beta1.Event{detection}, nil
}
```
...
```go
func (d *MyDetector) OnEvent(ctx context.Context, event *v1beta1.Event) ([]*v1beta1.Event, error) {
	derivedEvent := v1beta1.CreateEventFromBase(event)
	derivedEvent.Data = []*v1beta1.EventValue{...}
	// No auto-population
	return []*v1beta1.Event{derivedEvent}, nil
}
```
...
func TestMyDetector_OnEvent(t *testing.T) {
	...
	// Verify output
	detection := outputs[0]
	assert.Equal(t, "my_detection", detection.Name)

	// Verify data fields
	pathname, found := v1beta1.GetData[string](detection, "file_path")
	assert.True(t, found)
...
func (d *MyDetector) OnEvent(ctx context.Context, event *v1beta1.Event) ([]*v1beta1.Event, error) {
	...
	d.logger.Infow("Detection triggered",
		"file", pathname,
		"process", processName,
		"confidence", 95)
...
| Output | Async `ctx.Callback()` | Synchronous return `[]*v1beta1.Event` |
...
func (d *SensitiveFileAccess) OnEvent(ctx context.Context, event *v1beta1.Event) ([]*v1beta1.Event, error) {
	...
	// Threat, DetectedFrom, ProcessAncestry auto-populated
	return []*v1beta1.Event{detection}, nil
}
...
- [ ] Replace `ctx.Callback()` with synchronous `return []*v1beta1.Event{}`
- [ ] Add `AutoPopulateFields` for automatic enrichment
- [ ] Update tests to call `OnEvent()` directly (no callback mocking)
...
✅ **Good**:
```go
func OnEvent(ctx context.Context, event *v1beta1.Event) ([]*v1beta1.Event, error) {
...
func (d *PrivilegeEscalationDetector) OnEvent(ctx context.Context, event *v1beta1.Event) ([]*v1beta1.Event, error) {
	// Get process information
	entityId := event.Workload.Process.EntityId.Value
	proc, err := d.dataStores.Processes().GetProcess(entityId)
	if errors.Is(err, datastores.ErrNotFound) {
