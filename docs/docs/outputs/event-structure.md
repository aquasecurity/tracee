...
- [Output Formats](./output-formats.md) - How to format event output
- [Go Templates](./output-formats.md#go-template) - Using event fields in templates
- [Output Overview](./index.md) - Output system overview
- [Events Documentation](../events/index.md) - Available event types
