...
**📖 See the [Detector Documentation](../../detectors/) for complete guide and examples.**
...
The [Detector Developer Guide](../../detectors/developer-guide.md#migration-from-signatures) includes complete migration instructions with:
...
| Documentation | ✅ [Complete guide](../../detectors/) | ✅ [Legacy docs](./golang.md) |
